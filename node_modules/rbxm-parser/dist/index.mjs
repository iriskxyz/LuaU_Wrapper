...
var AccessoryDescription = class extends Instance {
  ...
  get Rotation() {
    return this.GetProp("Rotation", 14 /* Vector3 */);
  }
  set Rotation(value) {
    this.SetProp("Rotation", 14 /* Vector3 */, value);
  }
  get Scale() {
...
var AchievementService = class extends Instance {
  constructor() {
    super(true);
...
var ActivityHistoryEventService = class extends Instance {
  constructor() {
    super(true);
...
var Annotation = class extends Instance {
  constructor() {
    super();
...
var WorkspaceAnnotation = class extends Annotation {
  constructor() {
    super();
...
var AnnotationsService = class extends Instance {
  constructor() {
    super(true);
...
var AppLifecycleObserverService = class extends Instance {
  constructor() {
    super(true);
...
var AudioAnalyzer = class extends Instance {
  ...
  get SpectrumEnabled() {
    return this.GetProp("SpectrumEnabled", 2 /* Bool */);
  }
  set SpectrumEnabled(value) {
    this.SetProp("SpectrumEnabled", 2 /* Bool */, value);
  }
  get WindowSize() {
    return this.GetProp("WindowSize", 18 /* Enum */);
  }
  set WindowSize(value) {
    this.SetProp("WindowSize", 18 /* Enum */, value);
  }
};
var AudioChannelMixer = class extends Instance {
  constructor() {
    super();
  ...
  get Layout() {
    return this.GetProp("Layout", 18 /* Enum */);
  }
  set Layout(value) {
    this.SetProp("Layout", 18 /* Enum */, value);
  }
};
var AudioChannelSplitter = class extends Instance {
  constructor() {
    super();
...
var AudioChorus = class extends Instance {
  ...
  get Bypass() {
    return this.GetProp("Bypass", 2 /* Bool */);
  }
  set Bypass(value) {
    this.SetProp("Bypass", 2 /* Bool */, value);
  }
  get Depth() {
...
var AudioEcho = class extends Instance {
  ...
  get RampTime() {
    return this.GetProp("RampTime", 4 /* Float32 */);
  }
  set RampTime(value) {
    this.SetProp("RampTime", 4 /* Float32 */, value);
  }
  get WetLevel() {
...
var AudioEmitter = class extends Instance {
  ...
  get AngleAttenuation() {
    return this.GetProp("AngleAttenuation", 1 /* String */);
  }
  set AngleAttenuation(value) {
    this.SetProp("AngleAttenuation", 1 /* String */, value);
  }
  ...
  get SimulationFidelity() {
    return this.GetProp("SimulationFidelity", 18 /* Enum */);
  }
  set SimulationFidelity(value) {
    this.SetProp("SimulationFidelity", 18 /* Enum */, value);
  }
};
...
var AudioFilter = class extends Instance {
  constructor() {
    super();
  ...
  get FilterType() {
    return this.GetProp("FilterType", 18 /* Enum */);
  }
  set FilterType(value) {
    this.SetProp("FilterType", 18 /* Enum */, value);
  }
  get Frequency() {
  ...
  get Gain() {
    return this.GetProp("Gain", 4 /* Float32 */);
  }
  set Gain(value) {
    this.SetProp("Gain", 4 /* Float32 */, value);
  }
  get Q() {
    return this.GetProp("Q", 4 /* Float32 */);
  }
  set Q(value) {
    this.SetProp("Q", 4 /* Float32 */, value);
  }
};
...
var AudioFocusService = class extends Instance {
  constructor() {
    super(true);
...
var AudioLimiter = class extends Instance {
  constructor() {
    super();
  ...
  get MaxLevel() {
    return this.GetProp("MaxLevel", 4 /* Float32 */);
  }
  set MaxLevel(value) {
    this.SetProp("MaxLevel", 4 /* Float32 */, value);
  }
  get Release() {
    return this.GetProp("Release", 4 /* Float32 */);
  }
...
var AudioPlayer = class extends Instance {
  ...
  get Asset() {
    return this.GetProp("Asset", 1 /* String */);
  }
  set Asset(value) {
    this.SetProp("Asset", 1 /* String */, value);
  }
  /**@deprecated Deprecated by Roblox*/
  get AssetId() {
...
var AudioRecorder = class extends Instance {
  constructor() {
    super();
  ...
  get IsRecording() {
    return this.GetProp("IsRecording", 2 /* Bool */);
  }
  set IsRecording(value) {
    this.SetProp("IsRecording", 2 /* Bool */, value);
  }
};
...
var AudioTextToSpeech = class extends Instance {
  constructor() {
    super();
  ...
  get VoiceId() {
    return this.GetProp("VoiceId", 1 /* String */);
  }
  set VoiceId(value) {
    this.SetProp("VoiceId", 1 /* String */, value);
  }
  get Volume() {
    return this.GetProp("Volume", 4 /* Float32 */);
  }
...
var AuroraScriptService = class extends Instance {
  constructor() {
    super(true);
...
var AuroraService = class extends Instance {
  constructor() {
    super(true);
...
var AvatarAccessoryRules = class extends Instance {
  constructor() {
    super();
  ...
  get AccessoryMode() {
    return this.GetProp("AccessoryMode", 18 /* Enum */);
  }
  set AccessoryMode(value) {
    this.SetProp("AccessoryMode", 18 /* Enum */, value);
  }
  get CustomAccessoryMode() {
    return this.GetProp("CustomAccessoryMode", 18 /* Enum */);
  }
  set CustomAccessoryMode(value) {
    this.SetProp("CustomAccessoryMode", 18 /* Enum */, value);
  }
  get CustomBackAccessoryEnabled() {
    return this.GetProp("CustomBackAccessoryEnabled", 2 /* Bool */);
  }
  set CustomBackAccessoryEnabled(value) {
    this.SetProp("CustomBackAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomBackAccessoryId() {
    return this.GetProp("CustomBackAccessoryId", 27 /* Int64 */);
  }
  set CustomBackAccessoryId(value) {
    this.SetProp("CustomBackAccessoryId", 27 /* Int64 */, value);
  }
  get CustomFaceAccessoryEnabled() {
    return this.GetProp("CustomFaceAccessoryEnabled", 2 /* Bool */);
  }
  set CustomFaceAccessoryEnabled(value) {
    this.SetProp("CustomFaceAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomFaceAccessoryId() {
    return this.GetProp("CustomFaceAccessoryId", 27 /* Int64 */);
  }
  set CustomFaceAccessoryId(value) {
    this.SetProp("CustomFaceAccessoryId", 27 /* Int64 */, value);
  }
  get CustomFrontAccessoryEnabled() {
    return this.GetProp("CustomFrontAccessoryEnabled", 2 /* Bool */);
  }
  set CustomFrontAccessoryEnabled(value) {
    this.SetProp("CustomFrontAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomFrontAccessoryId() {
    return this.GetProp("CustomFrontAccessoryId", 27 /* Int64 */);
  }
  set CustomFrontAccessoryId(value) {
    this.SetProp("CustomFrontAccessoryId", 27 /* Int64 */, value);
  }
  get CustomHairAccessoryEnabled() {
    return this.GetProp("CustomHairAccessoryEnabled", 2 /* Bool */);
  }
  set CustomHairAccessoryEnabled(value) {
    this.SetProp("CustomHairAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomHairAccessoryId() {
    return this.GetProp("CustomHairAccessoryId", 27 /* Int64 */);
  }
  set CustomHairAccessoryId(value) {
    this.SetProp("CustomHairAccessoryId", 27 /* Int64 */, value);
  }
  get CustomHeadAccessoryEnabled() {
    return this.GetProp("CustomHeadAccessoryEnabled", 2 /* Bool */);
  }
  set CustomHeadAccessoryEnabled(value) {
    this.SetProp("CustomHeadAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomHeadAccessoryId() {
    return this.GetProp("CustomHeadAccessoryId", 27 /* Int64 */);
  }
  set CustomHeadAccessoryId(value) {
    this.SetProp("CustomHeadAccessoryId", 27 /* Int64 */, value);
  }
  get CustomNeckAccessoryEnabled() {
    return this.GetProp("CustomNeckAccessoryEnabled", 2 /* Bool */);
  }
  set CustomNeckAccessoryEnabled(value) {
    this.SetProp("CustomNeckAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomNeckAccessoryId() {
    return this.GetProp("CustomNeckAccessoryId", 27 /* Int64 */);
  }
  set CustomNeckAccessoryId(value) {
    this.SetProp("CustomNeckAccessoryId", 27 /* Int64 */, value);
  }
  get CustomShoulderAccessoryEnabled() {
    return this.GetProp("CustomShoulderAccessoryEnabled", 2 /* Bool */);
  }
  set CustomShoulderAccessoryEnabled(value) {
    this.SetProp("CustomShoulderAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomShoulderAccessoryId() {
    return this.GetProp("CustomShoulderAccessoryId", 27 /* Int64 */);
  }
  set CustomShoulderAccessoryId(value) {
    this.SetProp("CustomShoulderAccessoryId", 27 /* Int64 */, value);
  }
  get CustomWaistAccessoryEnabled() {
    return this.GetProp("CustomWaistAccessoryEnabled", 2 /* Bool */);
  }
  set CustomWaistAccessoryEnabled(value) {
    this.SetProp("CustomWaistAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomWaistAccessoryId() {
    return this.GetProp("CustomWaistAccessoryId", 27 /* Int64 */);
  }
  set CustomWaistAccessoryId(value) {
    this.SetProp("CustomWaistAccessoryId", 27 /* Int64 */, value);
  }
  get EnableSound() {
    return this.GetProp("EnableSound", 2 /* Bool */);
  }
  set EnableSound(value) {
    this.SetProp("EnableSound", 2 /* Bool */, value);
  }
  get EnableVFX() {
    return this.GetProp("EnableVFX", 2 /* Bool */);
  }
  set EnableVFX(value) {
    this.SetProp("EnableVFX", 2 /* Bool */, value);
  }
  get LimitBounds() {
    return this.GetProp("LimitBounds", 14 /* Vector3 */);
  }
  set LimitBounds(value) {
    this.SetProp("LimitBounds", 14 /* Vector3 */, value);
  }
  get LimitMethod() {
    return this.GetProp("LimitMethod", 18 /* Enum */);
  }
  set LimitMethod(value) {
    this.SetProp("LimitMethod", 18 /* Enum */, value);
  }
};
var AvatarAnimationRules = class extends Instance {
  constructor() {
    super();
  ...
  get AnimationClipsMode() {
    return this.GetProp("AnimationClipsMode", 18 /* Enum */);
  }
  set AnimationClipsMode(value) {
    this.SetProp("AnimationClipsMode", 18 /* Enum */, value);
  }
  get AnimationPacksMode() {
    return this.GetProp("AnimationPacksMode", 18 /* Enum */);
  }
  set AnimationPacksMode(value) {
    this.SetProp("AnimationPacksMode", 18 /* Enum */, value);
  }
  get CustomClimbAnimationEnabled() {
    return this.GetProp("CustomClimbAnimationEnabled", 2 /* Bool */);
  }
  set CustomClimbAnimationEnabled(value) {
    this.SetProp("CustomClimbAnimationEnabled", 2 /* Bool */, value);
  }
  get CustomClimbAnimationId() {
    return this.GetProp("CustomClimbAnimationId", 27 /* Int64 */);
  }
  set CustomClimbAnimationId(value) {
    this.SetProp("CustomClimbAnimationId", 27 /* Int64 */, value);
  }
  get CustomFallAnimationEnabled() {
    return this.GetProp("CustomFallAnimationEnabled", 2 /* Bool */);
  }
  set CustomFallAnimationEnabled(value) {
    this.SetProp("CustomFallAnimationEnabled", 2 /* Bool */, value);
  }
  get CustomFallAnimationId() {
    return this.GetProp("CustomFallAnimationId", 27 /* Int64 */);
  }
  set CustomFallAnimationId(value) {
    this.SetProp("CustomFallAnimationId", 27 /* Int64 */, value);
  }
  get CustomIdleAlt1AnimationEnabled() {
    return this.GetProp("CustomIdleAlt1AnimationEnabled", 2 /* Bool */);
  }
  set CustomIdleAlt1AnimationEnabled(value) {
    this.SetProp("CustomIdleAlt1AnimationEnabled", 2 /* Bool */, value);
  }
  get CustomIdleAlt1AnimationId() {
    return this.GetProp("CustomIdleAlt1AnimationId", 27 /* Int64 */);
  }
  set CustomIdleAlt1AnimationId(value) {
    this.SetProp("CustomIdleAlt1AnimationId", 27 /* Int64 */, value);
  }
  get CustomIdleAlt2AnimationEnabled() {
    return this.GetProp("CustomIdleAlt2AnimationEnabled", 2 /* Bool */);
  }
  set CustomIdleAlt2AnimationEnabled(value) {
    this.SetProp("CustomIdleAlt2AnimationEnabled", 2 /* Bool */, value);
  }
  get CustomIdleAlt2AnimationId() {
    return this.GetProp("CustomIdleAlt2AnimationId", 27 /* Int64 */);
  }
  set CustomIdleAlt2AnimationId(value) {
    this.SetProp("CustomIdleAlt2AnimationId", 27 /* Int64 */, value);
  }
  get CustomIdleAnimationEnabled() {
    return this.GetProp("CustomIdleAnimationEnabled", 2 /* Bool */);
  }
  set CustomIdleAnimationEnabled(value) {
    this.SetProp("CustomIdleAnimationEnabled", 2 /* Bool */, value);
  }
  get CustomIdleAnimationId() {
    return this.GetProp("CustomIdleAnimationId", 27 /* Int64 */);
  }
  set CustomIdleAnimationId(value) {
    this.SetProp("CustomIdleAnimationId", 27 /* Int64 */, value);
  }
  get CustomJumpAnimationEnabled() {
    return this.GetProp("CustomJumpAnimationEnabled", 2 /* Bool */);
  }
  set CustomJumpAnimationEnabled(value) {
    this.SetProp("CustomJumpAnimationEnabled", 2 /* Bool */, value);
  }
  get CustomJumpAnimationId() {
    return this.GetProp("CustomJumpAnimationId", 27 /* Int64 */);
  }
  set CustomJumpAnimationId(value) {
    this.SetProp("CustomJumpAnimationId", 27 /* Int64 */, value);
  }
  get CustomRunAnimationEnabled() {
    return this.GetProp("CustomRunAnimationEnabled", 2 /* Bool */);
  }
  set CustomRunAnimationEnabled(value) {
    this.SetProp("CustomRunAnimationEnabled", 2 /* Bool */, value);
  }
  get CustomRunAnimationId() {
    return this.GetProp("CustomRunAnimationId", 27 /* Int64 */);
  }
  set CustomRunAnimationId(value) {
    this.SetProp("CustomRunAnimationId", 27 /* Int64 */, value);
  }
  get CustomSwimAnimationEnabled() {
    return this.GetProp("CustomSwimAnimationEnabled", 2 /* Bool */);
  }
  set CustomSwimAnimationEnabled(value) {
    this.SetProp("CustomSwimAnimationEnabled", 2 /* Bool */, value);
  }
  get CustomSwimAnimationId() {
    return this.GetProp("CustomSwimAnimationId", 27 /* Int64 */);
  }
  set CustomSwimAnimationId(value) {
    this.SetProp("CustomSwimAnimationId", 27 /* Int64 */, value);
  }
  get CustomSwimIdleAnimationEnabled() {
    return this.GetProp("CustomSwimIdleAnimationEnabled", 2 /* Bool */);
  }
  set CustomSwimIdleAnimationEnabled(value) {
    this.SetProp("CustomSwimIdleAnimationEnabled", 2 /* Bool */, value);
  }
  get CustomSwimIdleAnimationId() {
    return this.GetProp("CustomSwimIdleAnimationId", 27 /* Int64 */);
  }
  set CustomSwimIdleAnimationId(value) {
    this.SetProp("CustomSwimIdleAnimationId", 27 /* Int64 */, value);
  }
  get CustomWalkAnimationEnabled() {
    return this.GetProp("CustomWalkAnimationEnabled", 2 /* Bool */);
  }
  set CustomWalkAnimationEnabled(value) {
    this.SetProp("CustomWalkAnimationEnabled", 2 /* Bool */, value);
  }
  get CustomWalkAnimationId() {
    return this.GetProp("CustomWalkAnimationId", 27 /* Int64 */);
  }
  set CustomWalkAnimationId(value) {
    this.SetProp("CustomWalkAnimationId", 27 /* Int64 */, value);
  }
};
var AvatarBodyRules = class extends Instance {
  constructor() {
    super();
  ...
  get AppearanceMode() {
    return this.GetProp("AppearanceMode", 18 /* Enum */);
  }
  set AppearanceMode(value) {
    this.SetProp("AppearanceMode", 18 /* Enum */, value);
  }
  get BuildMode() {
    return this.GetProp("BuildMode", 18 /* Enum */);
  }
  set BuildMode(value) {
    this.SetProp("BuildMode", 18 /* Enum */, value);
  }
  get CustomBodyAvatarReference() {
    return this.GetProp("CustomBodyAvatarReference", 19 /* Referent */);
  }
  set CustomBodyAvatarReference(value) {
    this.SetProp("CustomBodyAvatarReference", 19 /* Referent */, value);
  }
  get CustomBodyBundleId() {
    return this.GetProp("CustomBodyBundleId", 27 /* Int64 */);
  }
  set CustomBodyBundleId(value) {
    this.SetProp("CustomBodyBundleId", 27 /* Int64 */, value);
  }
  get CustomBodyType() {
    return this.GetProp("CustomBodyType", 18 /* Enum */);
  }
  set CustomBodyType(value) {
    this.SetProp("CustomBodyType", 18 /* Enum */, value);
  }
  get CustomBodyTypeScale() {
    return this.GetProp("CustomBodyTypeScale", 23 /* NumberRange */);
  }
  set CustomBodyTypeScale(value) {
    this.SetProp("CustomBodyTypeScale", 23 /* NumberRange */, value);
  }
  get CustomHeadEnabled() {
    return this.GetProp("CustomHeadEnabled", 2 /* Bool */);
  }
  set CustomHeadEnabled(value) {
    this.SetProp("CustomHeadEnabled", 2 /* Bool */, value);
  }
  get CustomHeadId() {
    return this.GetProp("CustomHeadId", 27 /* Int64 */);
  }
  set CustomHeadId(value) {
    this.SetProp("CustomHeadId", 27 /* Int64 */, value);
  }
  get CustomHeadScale() {
    return this.GetProp("CustomHeadScale", 23 /* NumberRange */);
  }
  set CustomHeadScale(value) {
    this.SetProp("CustomHeadScale", 23 /* NumberRange */, value);
  }
  get CustomHeight() {
    return this.GetProp("CustomHeight", 23 /* NumberRange */);
  }
  set CustomHeight(value) {
    this.SetProp("CustomHeight", 23 /* NumberRange */, value);
  }
  get CustomHeightScale() {
    return this.GetProp("CustomHeightScale", 23 /* NumberRange */);
  }
  set CustomHeightScale(value) {
    this.SetProp("CustomHeightScale", 23 /* NumberRange */, value);
  }
  get CustomLeftArmEnabled() {
    return this.GetProp("CustomLeftArmEnabled", 2 /* Bool */);
  }
  set CustomLeftArmEnabled(value) {
    this.SetProp("CustomLeftArmEnabled", 2 /* Bool */, value);
  }
  get CustomLeftArmId() {
    return this.GetProp("CustomLeftArmId", 27 /* Int64 */);
  }
  set CustomLeftArmId(value) {
    this.SetProp("CustomLeftArmId", 27 /* Int64 */, value);
  }
  get CustomLeftLegEnabled() {
    return this.GetProp("CustomLeftLegEnabled", 2 /* Bool */);
  }
  set CustomLeftLegEnabled(value) {
    this.SetProp("CustomLeftLegEnabled", 2 /* Bool */, value);
  }
  get CustomLeftLegId() {
    return this.GetProp("CustomLeftLegId", 27 /* Int64 */);
  }
  set CustomLeftLegId(value) {
    this.SetProp("CustomLeftLegId", 27 /* Int64 */, value);
  }
  get CustomProportionsScale() {
    return this.GetProp("CustomProportionsScale", 23 /* NumberRange */);
  }
  set CustomProportionsScale(value) {
    this.SetProp("CustomProportionsScale", 23 /* NumberRange */, value);
  }
  get CustomRightArmEnabled() {
    return this.GetProp("CustomRightArmEnabled", 2 /* Bool */);
  }
  set CustomRightArmEnabled(value) {
    this.SetProp("CustomRightArmEnabled", 2 /* Bool */, value);
  }
  get CustomRightArmId() {
    return this.GetProp("CustomRightArmId", 27 /* Int64 */);
  }
  set CustomRightArmId(value) {
    this.SetProp("CustomRightArmId", 27 /* Int64 */, value);
  }
  get CustomRightLegEnabled() {
    return this.GetProp("CustomRightLegEnabled", 2 /* Bool */);
  }
  set CustomRightLegEnabled(value) {
    this.SetProp("CustomRightLegEnabled", 2 /* Bool */, value);
  }
  get CustomRightLegId() {
    return this.GetProp("CustomRightLegId", 27 /* Int64 */);
  }
  set CustomRightLegId(value) {
    this.SetProp("CustomRightLegId", 27 /* Int64 */, value);
  }
  get CustomTorsoEnabled() {
    return this.GetProp("CustomTorsoEnabled", 2 /* Bool */);
  }
  set CustomTorsoEnabled(value) {
    this.SetProp("CustomTorsoEnabled", 2 /* Bool */, value);
  }
  get CustomTorsoId() {
    return this.GetProp("CustomTorsoId", 27 /* Int64 */);
  }
  set CustomTorsoId(value) {
    this.SetProp("CustomTorsoId", 27 /* Int64 */, value);
  }
  get CustomWidthScale() {
    return this.GetProp("CustomWidthScale", 23 /* NumberRange */);
  }
  set CustomWidthScale(value) {
    this.SetProp("CustomWidthScale", 23 /* NumberRange */, value);
  }
  get KeepPlayerHead() {
    return this.GetProp("KeepPlayerHead", 2 /* Bool */);
  }
  set KeepPlayerHead(value) {
    this.SetProp("KeepPlayerHead", 2 /* Bool */, value);
  }
  get ScaleMode() {
    return this.GetProp("ScaleMode", 18 /* Enum */);
  }
  set ScaleMode(value) {
    this.SetProp("ScaleMode", 18 /* Enum */, value);
  }
};
...
var AvatarClothingRules = class extends Instance {
  constructor() {
    super();
  ...
  get ClothingMode() {
    return this.GetProp("ClothingMode", 18 /* Enum */);
  }
  set ClothingMode(value) {
    this.SetProp("ClothingMode", 18 /* Enum */, value);
  }
  get CustomClassicPantsAccessoryEnabled() {
    return this.GetProp("CustomClassicPantsAccessoryEnabled", 2 /* Bool */);
  }
  set CustomClassicPantsAccessoryEnabled(value) {
    this.SetProp("CustomClassicPantsAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomClassicPantsAccessoryId() {
    return this.GetProp("CustomClassicPantsAccessoryId", 27 /* Int64 */);
  }
  set CustomClassicPantsAccessoryId(value) {
    this.SetProp("CustomClassicPantsAccessoryId", 27 /* Int64 */, value);
  }
  get CustomClassicShirtsAccessoryEnabled() {
    return this.GetProp("CustomClassicShirtsAccessoryEnabled", 2 /* Bool */);
  }
  set CustomClassicShirtsAccessoryEnabled(value) {
    this.SetProp("CustomClassicShirtsAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomClassicShirtsAccessoryId() {
    return this.GetProp("CustomClassicShirtsAccessoryId", 27 /* Int64 */);
  }
  set CustomClassicShirtsAccessoryId(value) {
    this.SetProp("CustomClassicShirtsAccessoryId", 27 /* Int64 */, value);
  }
  get CustomClassicTShirtsAccessoryEnabled() {
    return this.GetProp("CustomClassicTShirtsAccessoryEnabled", 2 /* Bool */);
  }
  set CustomClassicTShirtsAccessoryEnabled(value) {
    this.SetProp("CustomClassicTShirtsAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomClassicTShirtsAccessoryId() {
    return this.GetProp("CustomClassicTShirtsAccessoryId", 27 /* Int64 */);
  }
  set CustomClassicTShirtsAccessoryId(value) {
    this.SetProp("CustomClassicTShirtsAccessoryId", 27 /* Int64 */, value);
  }
  get CustomClothingMode() {
    return this.GetProp("CustomClothingMode", 18 /* Enum */);
  }
  set CustomClothingMode(value) {
    this.SetProp("CustomClothingMode", 18 /* Enum */, value);
  }
  get CustomDressSkirtAccessoryEnabled() {
    return this.GetProp("CustomDressSkirtAccessoryEnabled", 2 /* Bool */);
  }
  set CustomDressSkirtAccessoryEnabled(value) {
    this.SetProp("CustomDressSkirtAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomDressSkirtAccessoryId() {
    return this.GetProp("CustomDressSkirtAccessoryId", 27 /* Int64 */);
  }
  set CustomDressSkirtAccessoryId(value) {
    this.SetProp("CustomDressSkirtAccessoryId", 27 /* Int64 */, value);
  }
  get CustomJacketAccessoryEnabled() {
    return this.GetProp("CustomJacketAccessoryEnabled", 2 /* Bool */);
  }
  set CustomJacketAccessoryEnabled(value) {
    this.SetProp("CustomJacketAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomJacketAccessoryId() {
    return this.GetProp("CustomJacketAccessoryId", 27 /* Int64 */);
  }
  set CustomJacketAccessoryId(value) {
    this.SetProp("CustomJacketAccessoryId", 27 /* Int64 */, value);
  }
  get CustomLeftShoesAccessoryEnabled() {
    return this.GetProp("CustomLeftShoesAccessoryEnabled", 2 /* Bool */);
  }
  set CustomLeftShoesAccessoryEnabled(value) {
    this.SetProp("CustomLeftShoesAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomLeftShoesAccessoryId() {
    return this.GetProp("CustomLeftShoesAccessoryId", 27 /* Int64 */);
  }
  set CustomLeftShoesAccessoryId(value) {
    this.SetProp("CustomLeftShoesAccessoryId", 27 /* Int64 */, value);
  }
  get CustomPantsAccessoryEnabled() {
    return this.GetProp("CustomPantsAccessoryEnabled", 2 /* Bool */);
  }
  set CustomPantsAccessoryEnabled(value) {
    this.SetProp("CustomPantsAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomPantsAccessoryId() {
    return this.GetProp("CustomPantsAccessoryId", 27 /* Int64 */);
  }
  set CustomPantsAccessoryId(value) {
    this.SetProp("CustomPantsAccessoryId", 27 /* Int64 */, value);
  }
  get CustomRightShoesAccessoryEnabled() {
    return this.GetProp("CustomRightShoesAccessoryEnabled", 2 /* Bool */);
  }
  set CustomRightShoesAccessoryEnabled(value) {
    this.SetProp("CustomRightShoesAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomRightShoesAccessoryId() {
    return this.GetProp("CustomRightShoesAccessoryId", 27 /* Int64 */);
  }
  set CustomRightShoesAccessoryId(value) {
    this.SetProp("CustomRightShoesAccessoryId", 27 /* Int64 */, value);
  }
  get CustomShirtAccessoryEnabled() {
    return this.GetProp("CustomShirtAccessoryEnabled", 2 /* Bool */);
  }
  set CustomShirtAccessoryEnabled(value) {
    this.SetProp("CustomShirtAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomShirtAccessoryId() {
    return this.GetProp("CustomShirtAccessoryId", 27 /* Int64 */);
  }
  set CustomShirtAccessoryId(value) {
    this.SetProp("CustomShirtAccessoryId", 27 /* Int64 */, value);
  }
  get CustomShortsAccessoryEnabled() {
    return this.GetProp("CustomShortsAccessoryEnabled", 2 /* Bool */);
  }
  set CustomShortsAccessoryEnabled(value) {
    this.SetProp("CustomShortsAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomShortsAccessoryId() {
    return this.GetProp("CustomShortsAccessoryId", 27 /* Int64 */);
  }
  set CustomShortsAccessoryId(value) {
    this.SetProp("CustomShortsAccessoryId", 27 /* Int64 */, value);
  }
  get CustomSweaterAccessoryEnabled() {
    return this.GetProp("CustomSweaterAccessoryEnabled", 2 /* Bool */);
  }
  set CustomSweaterAccessoryEnabled(value) {
    this.SetProp("CustomSweaterAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomSweaterAccessoryId() {
    return this.GetProp("CustomSweaterAccessoryId", 27 /* Int64 */);
  }
  set CustomSweaterAccessoryId(value) {
    this.SetProp("CustomSweaterAccessoryId", 27 /* Int64 */, value);
  }
  get CustomTShirtAccessoryEnabled() {
    return this.GetProp("CustomTShirtAccessoryEnabled", 2 /* Bool */);
  }
  set CustomTShirtAccessoryEnabled(value) {
    this.SetProp("CustomTShirtAccessoryEnabled", 2 /* Bool */, value);
  }
  get CustomTShirtAccessoryId() {
    return this.GetProp("CustomTShirtAccessoryId", 27 /* Int64 */);
  }
  set CustomTShirtAccessoryId(value) {
    this.SetProp("CustomTShirtAccessoryId", 27 /* Int64 */, value);
  }
  get LimitBounds() {
    return this.GetProp("LimitBounds", 14 /* Vector3 */);
  }
...
var AvatarCollisionRules = class extends Instance {
  constructor() {
    super();
  ...
  get CollisionMode() {
    return this.GetProp("CollisionMode", 18 /* Enum */);
  }
  set CollisionMode(value) {
    this.SetProp("CollisionMode", 18 /* Enum */, value);
  }
  get HitAndTouchDetectionMode() {
    return this.GetProp("HitAndTouchDetectionMode", 18 /* Enum */);
  }
  set HitAndTouchDetectionMode(value) {
    this.SetProp("HitAndTouchDetectionMode", 18 /* Enum */, value);
  }
  get LegacyCollisionMode() {
    return this.GetProp("LegacyCollisionMode", 18 /* Enum */);
  }
  set LegacyCollisionMode(value) {
    this.SetProp("LegacyCollisionMode", 18 /* Enum */, value);
  }
  get SingleColliderSize() {
    return this.GetProp("SingleColliderSize", 14 /* Vector3 */);
  }
  set SingleColliderSize(value) {
    this.SetProp("SingleColliderSize", 14 /* Vector3 */, value);
  }
};
...
var AvatarPreloader = class extends Instance {
  constructor() {
    super(true);
...
var AvatarRules = class extends Instance {
  constructor() {
    super();
  ...
  get AvatarType() {
    return this.GetProp("AvatarType", 18 /* Enum */);
  }
  set AvatarType(value) {
    this.SetProp("AvatarType", 18 /* Enum */, value);
  }
};
var AvatarSettings = class extends Instance {
  constructor() {
    super(true);
...
var StarterGui = class extends BasePlayerGui {
  ...
  get StudioDefaultStyleSheet() {
    return this.GetProp("StudioDefaultStyleSheet", 19 /* Referent */);
  }
  set StudioDefaultStyleSheet(value) {
    this.SetProp("StudioDefaultStyleSheet", 19 /* Referent */, value);
  }
  get StudioInsertWidgetLayerCollectorAutoLinkStyleSheet() {
    return this.GetProp("StudioInsertWidgetLayerCollectorAutoLinkStyleSheet", 19 /* Referent */);
  }
  set StudioInsertWidgetLayerCollectorAutoLinkStyleSheet(value) {
    this.SetProp("StudioInsertWidgetLayerCollectorAutoLinkStyleSheet", 19 /* Referent */, value);
  }
...
var BaseWrap = class extends Instance {
  ...
  get CageMeshContent() {
    return this.GetProp("CageMeshContent", 1 /* String */);
  }
  set CageMeshContent(value) {
    this.SetProp("CageMeshContent", 1 /* String */, value);
  }
  get CageMeshId() {
  ...
  get MaxSize() {
    return this.GetProp("MaxSize", 14 /* Vector3 */);
  }
  set MaxSize(value) {
    this.SetProp("MaxSize", 14 /* Vector3 */, value);
  }
  get Offset() {
...
var WrapDeformer = class extends BaseWrap {
  constructor() {
    super();
...
var WrapLayer = class extends BaseWrap {
  ...
  get ReferenceMeshContent() {
    return this.GetProp("ReferenceMeshContent", 1 /* String */);
  }
  set ReferenceMeshContent(value) {
    this.SetProp("ReferenceMeshContent", 1 /* String */, value);
  }
  get ReferenceMeshId() {
...
var BugReporterService = class extends Instance {
  constructor() {
    super(true);
...
var Chat = class extends Instance {
  ...
  get IsAutoMigrated() {
    return this.GetProp("IsAutoMigrated", 2 /* Bool */);
  }
  set IsAutoMigrated(value) {
    this.SetProp("IsAutoMigrated", 2 /* Bool */, value);
  }
  get LoadDefaultChat() {
...
var CloudCRUDService = class extends Instance {
  constructor() {
    super(true);
...
var ConfigService = class extends Instance {
  constructor() {
    super(true);
...
var CreatorStoreService = class extends Instance {
  constructor() {
    super(true);
...
var CustomLog = class extends Instance {
  constructor() {
    super();
...
var EditableService = class extends Instance {
  constructor() {
    super(true);
...
var ExplorerFilter = class extends Instance {
  constructor() {
    super();
...
var ExplorerServiceVisibilityService = class extends Instance {
  constructor() {
    super(true);
...
var Decal = class extends FaceInstance {
  ...
  get TextureContent() {
    return this.GetProp("TextureContent", 1 /* String */);
  }
  set TextureContent(value) {
    this.SetProp("TextureContent", 1 /* String */, value);
  }
  get Transparency() {
...
var FacialAgeEstimationService = class extends Instance {
  constructor() {
    super(true);
...
var FeatureRestrictionManager = class extends Instance {
  constructor() {
    super(true);
...
var FeedService = class extends Instance {
  constructor() {
    super(true);
...
var GenerationService = class extends Instance {
  constructor() {
    super(true);
...
var GuiButton = class extends GuiObject {
  ...
  get HoverHapticEffect() {
    return this.GetProp("HoverHapticEffect", 19 /* Referent */);
  }
  set HoverHapticEffect(value) {
    this.SetProp("HoverHapticEffect", 19 /* Referent */, value);
  }
  get Modal() {
  ...
  get PressHapticEffect() {
    return this.GetProp("PressHapticEffect", 19 /* Referent */);
  }
  set PressHapticEffect(value) {
    this.SetProp("PressHapticEffect", 19 /* Referent */, value);
  }
  get Selected() {
...
var ImageButton = class extends GuiButton {
  ...
  get HoverImageContent() {
    return this.GetProp("HoverImageContent", 1 /* String */);
  }
  set HoverImageContent(value) {
    this.SetProp("HoverImageContent", 1 /* String */, value);
  }
  get Image() {
  ...
  get ImageContent() {
    return this.GetProp("ImageContent", 1 /* String */);
  }
  set ImageContent(value) {
    this.SetProp("ImageContent", 1 /* String */, value);
  }
  get ImageRectOffset() {
  ...
  get PressedImageContent() {
    return this.GetProp("PressedImageContent", 1 /* String */);
  }
  set PressedImageContent(value) {
    this.SetProp("PressedImageContent", 1 /* String */, value);
  }
  get ResampleMode() {
...
var TextButton = class extends GuiButton {
  ...
  get OpenTypeFeatures() {
    return this.GetProp("OpenTypeFeatures", 1 /* String */);
  }
  set OpenTypeFeatures(value) {
    this.SetProp("OpenTypeFeatures", 1 /* String */, value);
  }
  get RichText() {
    return this.GetProp("RichText", 2 /* Bool */);
  }
...
var RelativeGui = class extends GuiObject {
  constructor() {
    super();
...
var VideoDisplay = class extends GuiObject {
  constructor() {
    super();
  ...
  get VideoColor3() {
    return this.GetProp("VideoColor3", 12 /* Color3 */);
  }
  set VideoColor3(value) {
    this.SetProp("VideoColor3", 12 /* Color3 */, value);
  }
  get VideoRectOffset() {
    return this.GetProp("VideoRectOffset", 13 /* Vector2 */);
  }
  set VideoRectOffset(value) {
    this.SetProp("VideoRectOffset", 13 /* Vector2 */, value);
  }
  get VideoRectSize() {
    return this.GetProp("VideoRectSize", 13 /* Vector2 */);
  }
  set VideoRectSize(value) {
    this.SetProp("VideoRectSize", 13 /* Vector2 */, value);
  }
  get VideoTransparency() {
    return this.GetProp("VideoTransparency", 4 /* Float32 */);
  }
  set VideoTransparency(value) {
    this.SetProp("VideoTransparency", 4 /* Float32 */, value);
  }
};
var VideoFrame = class extends GuiObject {
  ...
  get VideoContent() {
    return this.GetProp("VideoContent", 1 /* String */);
  }
  set VideoContent(value) {
    this.SetProp("VideoContent", 1 /* String */, value);
  }
  get Volume() {
    return this.GetProp("Volume", 4 /* Float32 */);
  }
...
var Path2D = class extends GuiBase {
  ...
  get Closed() {
    return this.GetProp("Closed", 2 /* Bool */);
  }
  set Closed(value) {
    this.SetProp("Closed", 2 /* Bool */, value);
  }
  get Color3() {
    return this.GetProp("Color3", 12 /* Color3 */);
  }
...
var HapticEffect = class extends Instance {
  constructor() {
    super();
  ...
  get Waveform() {
    return this.GetProp("Waveform", 19 /* Referent */);
  }
  set Waveform(value) {
    this.SetProp("Waveform", 19 /* Referent */, value);
  }
};
...
var HeapProfilerService = class extends Instance {
  constructor() {
    super(true);
...
var HeatmapService = class extends Instance {
  constructor() {
    super(true);
...
var HumanoidRigDescription = class extends Instance {
  constructor() {
    super();
  ...
  get Chest() {
    return this.GetProp("Chest", 19 /* Referent */);
  }
  set Chest(value) {
    this.SetProp("Chest", 19 /* Referent */, value);
  }
  get ChestRangeMax() {
    return this.GetProp("ChestRangeMax", 14 /* Vector3 */);
  }
  set ChestRangeMax(value) {
    this.SetProp("ChestRangeMax", 14 /* Vector3 */, value);
  }
  get ChestRangeMin() {
    return this.GetProp("ChestRangeMin", 14 /* Vector3 */);
  }
  set ChestRangeMin(value) {
    this.SetProp("ChestRangeMin", 14 /* Vector3 */, value);
  }
  get ChestSize() {
    return this.GetProp("ChestSize", 4 /* Float32 */);
  }
  set ChestSize(value) {
    this.SetProp("ChestSize", 4 /* Float32 */, value);
  }
  get ChestTposeAdjustment() {
    return this.GetProp("ChestTposeAdjustment", 16 /* CFrame */);
  }
  set ChestTposeAdjustment(value) {
    this.SetProp("ChestTposeAdjustment", 16 /* CFrame */, value);
  }
  get Head() {
    return this.GetProp("Head", 19 /* Referent */);
  }
  set Head(value) {
    this.SetProp("Head", 19 /* Referent */, value);
  }
  get HeadRangeMax() {
    return this.GetProp("HeadRangeMax", 14 /* Vector3 */);
  }
  set HeadRangeMax(value) {
    this.SetProp("HeadRangeMax", 14 /* Vector3 */, value);
  }
  get HeadRangeMin() {
    return this.GetProp("HeadRangeMin", 14 /* Vector3 */);
  }
  set HeadRangeMin(value) {
    this.SetProp("HeadRangeMin", 14 /* Vector3 */, value);
  }
  get HeadSize() {
    return this.GetProp("HeadSize", 4 /* Float32 */);
  }
  set HeadSize(value) {
    this.SetProp("HeadSize", 4 /* Float32 */, value);
  }
  get HeadTposeAdjustment() {
    return this.GetProp("HeadTposeAdjustment", 16 /* CFrame */);
  }
  set HeadTposeAdjustment(value) {
    this.SetProp("HeadTposeAdjustment", 16 /* CFrame */, value);
  }
  get LeftAnkle() {
    return this.GetProp("LeftAnkle", 19 /* Referent */);
  }
  set LeftAnkle(value) {
    this.SetProp("LeftAnkle", 19 /* Referent */, value);
  }
  get LeftAnkleRangeMax() {
    return this.GetProp("LeftAnkleRangeMax", 14 /* Vector3 */);
  }
  set LeftAnkleRangeMax(value) {
    this.SetProp("LeftAnkleRangeMax", 14 /* Vector3 */, value);
  }
  get LeftAnkleRangeMin() {
    return this.GetProp("LeftAnkleRangeMin", 14 /* Vector3 */);
  }
  set LeftAnkleRangeMin(value) {
    this.SetProp("LeftAnkleRangeMin", 14 /* Vector3 */, value);
  }
  get LeftAnkleSize() {
    return this.GetProp("LeftAnkleSize", 4 /* Float32 */);
  }
  set LeftAnkleSize(value) {
    this.SetProp("LeftAnkleSize", 4 /* Float32 */, value);
  }
  get LeftAnkleTposeAdjustment() {
    return this.GetProp("LeftAnkleTposeAdjustment", 16 /* CFrame */);
  }
  set LeftAnkleTposeAdjustment(value) {
    this.SetProp("LeftAnkleTposeAdjustment", 16 /* CFrame */, value);
  }
  get LeftClavicle() {
    return this.GetProp("LeftClavicle", 19 /* Referent */);
  }
  set LeftClavicle(value) {
    this.SetProp("LeftClavicle", 19 /* Referent */, value);
  }
  get LeftClavicleRangeMax() {
    return this.GetProp("LeftClavicleRangeMax", 14 /* Vector3 */);
  }
  set LeftClavicleRangeMax(value) {
    this.SetProp("LeftClavicleRangeMax", 14 /* Vector3 */, value);
  }
  get LeftClavicleRangeMin() {
    return this.GetProp("LeftClavicleRangeMin", 14 /* Vector3 */);
  }
  set LeftClavicleRangeMin(value) {
    this.SetProp("LeftClavicleRangeMin", 14 /* Vector3 */, value);
  }
  get LeftClavicleSize() {
    return this.GetProp("LeftClavicleSize", 4 /* Float32 */);
  }
  set LeftClavicleSize(value) {
    this.SetProp("LeftClavicleSize", 4 /* Float32 */, value);
  }
  get LeftClavicleTposeAdjustment() {
    return this.GetProp("LeftClavicleTposeAdjustment", 16 /* CFrame */);
  }
  set LeftClavicleTposeAdjustment(value) {
    this.SetProp("LeftClavicleTposeAdjustment", 16 /* CFrame */, value);
  }
  get LeftElbow() {
    return this.GetProp("LeftElbow", 19 /* Referent */);
  }
  set LeftElbow(value) {
    this.SetProp("LeftElbow", 19 /* Referent */, value);
  }
  get LeftElbowRangeMax() {
    return this.GetProp("LeftElbowRangeMax", 14 /* Vector3 */);
  }
  set LeftElbowRangeMax(value) {
    this.SetProp("LeftElbowRangeMax", 14 /* Vector3 */, value);
  }
  get LeftElbowRangeMin() {
    return this.GetProp("LeftElbowRangeMin", 14 /* Vector3 */);
  }
  set LeftElbowRangeMin(value) {
    this.SetProp("LeftElbowRangeMin", 14 /* Vector3 */, value);
  }
  get LeftElbowSize() {
    return this.GetProp("LeftElbowSize", 4 /* Float32 */);
  }
  set LeftElbowSize(value) {
    this.SetProp("LeftElbowSize", 4 /* Float32 */, value);
  }
  get LeftElbowTposeAdjustment() {
    return this.GetProp("LeftElbowTposeAdjustment", 16 /* CFrame */);
  }
  set LeftElbowTposeAdjustment(value) {
    this.SetProp("LeftElbowTposeAdjustment", 16 /* CFrame */, value);
  }
  get LeftHip() {
    return this.GetProp("LeftHip", 19 /* Referent */);
  }
  set LeftHip(value) {
    this.SetProp("LeftHip", 19 /* Referent */, value);
  }
  get LeftHipRangeMax() {
    return this.GetProp("LeftHipRangeMax", 14 /* Vector3 */);
  }
  set LeftHipRangeMax(value) {
    this.SetProp("LeftHipRangeMax", 14 /* Vector3 */, value);
  }
  get LeftHipRangeMin() {
    return this.GetProp("LeftHipRangeMin", 14 /* Vector3 */);
  }
  set LeftHipRangeMin(value) {
    this.SetProp("LeftHipRangeMin", 14 /* Vector3 */, value);
  }
  get LeftHipSize() {
    return this.GetProp("LeftHipSize", 4 /* Float32 */);
  }
  set LeftHipSize(value) {
    this.SetProp("LeftHipSize", 4 /* Float32 */, value);
  }
  get LeftHipTposeAdjustment() {
    return this.GetProp("LeftHipTposeAdjustment", 16 /* CFrame */);
  }
  set LeftHipTposeAdjustment(value) {
    this.SetProp("LeftHipTposeAdjustment", 16 /* CFrame */, value);
  }
  get LeftKnee() {
    return this.GetProp("LeftKnee", 19 /* Referent */);
  }
  set LeftKnee(value) {
    this.SetProp("LeftKnee", 19 /* Referent */, value);
  }
  get LeftKneeRangeMax() {
    return this.GetProp("LeftKneeRangeMax", 14 /* Vector3 */);
  }
  set LeftKneeRangeMax(value) {
    this.SetProp("LeftKneeRangeMax", 14 /* Vector3 */, value);
  }
  get LeftKneeRangeMin() {
    return this.GetProp("LeftKneeRangeMin", 14 /* Vector3 */);
  }
  set LeftKneeRangeMin(value) {
    this.SetProp("LeftKneeRangeMin", 14 /* Vector3 */, value);
  }
  get LeftKneeSize() {
    return this.GetProp("LeftKneeSize", 4 /* Float32 */);
  }
  set LeftKneeSize(value) {
    this.SetProp("LeftKneeSize", 4 /* Float32 */, value);
  }
  get LeftKneeTposeAdjustment() {
    return this.GetProp("LeftKneeTposeAdjustment", 16 /* CFrame */);
  }
  set LeftKneeTposeAdjustment(value) {
    this.SetProp("LeftKneeTposeAdjustment", 16 /* CFrame */, value);
  }
  get LeftShoulder() {
    return this.GetProp("LeftShoulder", 19 /* Referent */);
  }
  set LeftShoulder(value) {
    this.SetProp("LeftShoulder", 19 /* Referent */, value);
  }
  get LeftShoulderRangeMax() {
    return this.GetProp("LeftShoulderRangeMax", 14 /* Vector3 */);
  }
  set LeftShoulderRangeMax(value) {
    this.SetProp("LeftShoulderRangeMax", 14 /* Vector3 */, value);
  }
  get LeftShoulderRangeMin() {
    return this.GetProp("LeftShoulderRangeMin", 14 /* Vector3 */);
  }
  set LeftShoulderRangeMin(value) {
    this.SetProp("LeftShoulderRangeMin", 14 /* Vector3 */, value);
  }
  get LeftShoulderSize() {
    return this.GetProp("LeftShoulderSize", 4 /* Float32 */);
  }
  set LeftShoulderSize(value) {
    this.SetProp("LeftShoulderSize", 4 /* Float32 */, value);
  }
  get LeftShoulderTposeAdjustment() {
    return this.GetProp("LeftShoulderTposeAdjustment", 16 /* CFrame */);
  }
  set LeftShoulderTposeAdjustment(value) {
    this.SetProp("LeftShoulderTposeAdjustment", 16 /* CFrame */, value);
  }
  get LeftToes() {
    return this.GetProp("LeftToes", 19 /* Referent */);
  }
  set LeftToes(value) {
    this.SetProp("LeftToes", 19 /* Referent */, value);
  }
  get LeftToesRangeMax() {
    return this.GetProp("LeftToesRangeMax", 14 /* Vector3 */);
  }
  set LeftToesRangeMax(value) {
    this.SetProp("LeftToesRangeMax", 14 /* Vector3 */, value);
  }
  get LeftToesRangeMin() {
    return this.GetProp("LeftToesRangeMin", 14 /* Vector3 */);
  }
  set LeftToesRangeMin(value) {
    this.SetProp("LeftToesRangeMin", 14 /* Vector3 */, value);
  }
  get LeftToesSize() {
    return this.GetProp("LeftToesSize", 4 /* Float32 */);
  }
  set LeftToesSize(value) {
    this.SetProp("LeftToesSize", 4 /* Float32 */, value);
  }
  get LeftToesTposeAdjustment() {
    return this.GetProp("LeftToesTposeAdjustment", 16 /* CFrame */);
  }
  set LeftToesTposeAdjustment(value) {
    this.SetProp("LeftToesTposeAdjustment", 16 /* CFrame */, value);
  }
  get LeftWrist() {
    return this.GetProp("LeftWrist", 19 /* Referent */);
  }
  set LeftWrist(value) {
    this.SetProp("LeftWrist", 19 /* Referent */, value);
  }
  get LeftWristRangeMax() {
    return this.GetProp("LeftWristRangeMax", 14 /* Vector3 */);
  }
  set LeftWristRangeMax(value) {
    this.SetProp("LeftWristRangeMax", 14 /* Vector3 */, value);
  }
  get LeftWristRangeMin() {
    return this.GetProp("LeftWristRangeMin", 14 /* Vector3 */);
  }
  set LeftWristRangeMin(value) {
    this.SetProp("LeftWristRangeMin", 14 /* Vector3 */, value);
  }
  get LeftWristSize() {
    return this.GetProp("LeftWristSize", 4 /* Float32 */);
  }
  set LeftWristSize(value) {
    this.SetProp("LeftWristSize", 4 /* Float32 */, value);
  }
  get LeftWristTposeAdjustment() {
    return this.GetProp("LeftWristTposeAdjustment", 16 /* CFrame */);
  }
  set LeftWristTposeAdjustment(value) {
    this.SetProp("LeftWristTposeAdjustment", 16 /* CFrame */, value);
  }
  get Neck() {
    return this.GetProp("Neck", 19 /* Referent */);
  }
  set Neck(value) {
    this.SetProp("Neck", 19 /* Referent */, value);
  }
  get NeckRangeMax() {
    return this.GetProp("NeckRangeMax", 14 /* Vector3 */);
  }
  set NeckRangeMax(value) {
    this.SetProp("NeckRangeMax", 14 /* Vector3 */, value);
  }
  get NeckRangeMin() {
    return this.GetProp("NeckRangeMin", 14 /* Vector3 */);
  }
  set NeckRangeMin(value) {
    this.SetProp("NeckRangeMin", 14 /* Vector3 */, value);
  }
  get NeckSize() {
    return this.GetProp("NeckSize", 4 /* Float32 */);
  }
  set NeckSize(value) {
    this.SetProp("NeckSize", 4 /* Float32 */, value);
  }
  get NeckTposeAdjustment() {
    return this.GetProp("NeckTposeAdjustment", 16 /* CFrame */);
  }
  set NeckTposeAdjustment(value) {
    this.SetProp("NeckTposeAdjustment", 16 /* CFrame */, value);
  }
  get Pelvis() {
    return this.GetProp("Pelvis", 19 /* Referent */);
  }
  set Pelvis(value) {
    this.SetProp("Pelvis", 19 /* Referent */, value);
  }
  get PelvisRangeMax() {
    return this.GetProp("PelvisRangeMax", 14 /* Vector3 */);
  }
  set PelvisRangeMax(value) {
    this.SetProp("PelvisRangeMax", 14 /* Vector3 */, value);
  }
  get PelvisRangeMin() {
    return this.GetProp("PelvisRangeMin", 14 /* Vector3 */);
  }
  set PelvisRangeMin(value) {
    this.SetProp("PelvisRangeMin", 14 /* Vector3 */, value);
  }
  get PelvisSize() {
    return this.GetProp("PelvisSize", 4 /* Float32 */);
  }
  set PelvisSize(value) {
    this.SetProp("PelvisSize", 4 /* Float32 */, value);
  }
  get PelvisTposeAdjustment() {
    return this.GetProp("PelvisTposeAdjustment", 16 /* CFrame */);
  }
  set PelvisTposeAdjustment(value) {
    this.SetProp("PelvisTposeAdjustment", 16 /* CFrame */, value);
  }
  get RightAnkle() {
    return this.GetProp("RightAnkle", 19 /* Referent */);
  }
  set RightAnkle(value) {
    this.SetProp("RightAnkle", 19 /* Referent */, value);
  }
  get RightAnkleRangeMax() {
    return this.GetProp("RightAnkleRangeMax", 14 /* Vector3 */);
  }
  set RightAnkleRangeMax(value) {
    this.SetProp("RightAnkleRangeMax", 14 /* Vector3 */, value);
  }
  get RightAnkleRangeMin() {
    return this.GetProp("RightAnkleRangeMin", 14 /* Vector3 */);
  }
  set RightAnkleRangeMin(value) {
    this.SetProp("RightAnkleRangeMin", 14 /* Vector3 */, value);
  }
  get RightAnkleSize() {
    return this.GetProp("RightAnkleSize", 4 /* Float32 */);
  }
  set RightAnkleSize(value) {
    this.SetProp("RightAnkleSize", 4 /* Float32 */, value);
  }
  get RightAnkleTposeAdjustment() {
    return this.GetProp("RightAnkleTposeAdjustment", 16 /* CFrame */);
  }
  set RightAnkleTposeAdjustment(value) {
    this.SetProp("RightAnkleTposeAdjustment", 16 /* CFrame */, value);
  }
  get RightClavicle() {
    return this.GetProp("RightClavicle", 19 /* Referent */);
  }
  set RightClavicle(value) {
    this.SetProp("RightClavicle", 19 /* Referent */, value);
  }
  get RightClavicleRangeMax() {
    return this.GetProp("RightClavicleRangeMax", 14 /* Vector3 */);
  }
  set RightClavicleRangeMax(value) {
    this.SetProp("RightClavicleRangeMax", 14 /* Vector3 */, value);
  }
  get RightClavicleRangeMin() {
    return this.GetProp("RightClavicleRangeMin", 14 /* Vector3 */);
  }
  set RightClavicleRangeMin(value) {
    this.SetProp("RightClavicleRangeMin", 14 /* Vector3 */, value);
  }
  get RightClavicleSize() {
    return this.GetProp("RightClavicleSize", 4 /* Float32 */);
  }
  set RightClavicleSize(value) {
    this.SetProp("RightClavicleSize", 4 /* Float32 */, value);
  }
  get RightClavicleTposeAdjustment() {
    return this.GetProp("RightClavicleTposeAdjustment", 16 /* CFrame */);
  }
  set RightClavicleTposeAdjustment(value) {
    this.SetProp("RightClavicleTposeAdjustment", 16 /* CFrame */, value);
  }
  get RightElbow() {
    return this.GetProp("RightElbow", 19 /* Referent */);
  }
  set RightElbow(value) {
    this.SetProp("RightElbow", 19 /* Referent */, value);
  }
  get RightElbowRangeMax() {
    return this.GetProp("RightElbowRangeMax", 14 /* Vector3 */);
  }
  set RightElbowRangeMax(value) {
    this.SetProp("RightElbowRangeMax", 14 /* Vector3 */, value);
  }
  get RightElbowRangeMin() {
    return this.GetProp("RightElbowRangeMin", 14 /* Vector3 */);
  }
  set RightElbowRangeMin(value) {
    this.SetProp("RightElbowRangeMin", 14 /* Vector3 */, value);
  }
  get RightElbowSize() {
    return this.GetProp("RightElbowSize", 4 /* Float32 */);
  }
  set RightElbowSize(value) {
    this.SetProp("RightElbowSize", 4 /* Float32 */, value);
  }
  get RightElbowTposeAdjustment() {
    return this.GetProp("RightElbowTposeAdjustment", 16 /* CFrame */);
  }
  set RightElbowTposeAdjustment(value) {
    this.SetProp("RightElbowTposeAdjustment", 16 /* CFrame */, value);
  }
  get RightHip() {
    return this.GetProp("RightHip", 19 /* Referent */);
  }
  set RightHip(value) {
    this.SetProp("RightHip", 19 /* Referent */, value);
  }
  get RightHipRangeMax() {
    return this.GetProp("RightHipRangeMax", 14 /* Vector3 */);
  }
  set RightHipRangeMax(value) {
    this.SetProp("RightHipRangeMax", 14 /* Vector3 */, value);
  }
  get RightHipRangeMin() {
    return this.GetProp("RightHipRangeMin", 14 /* Vector3 */);
  }
  set RightHipRangeMin(value) {
    this.SetProp("RightHipRangeMin", 14 /* Vector3 */, value);
  }
  get RightHipSize() {
    return this.GetProp("RightHipSize", 4 /* Float32 */);
  }
  set RightHipSize(value) {
    this.SetProp("RightHipSize", 4 /* Float32 */, value);
  }
  get RightHipTposeAdjustment() {
    return this.GetProp("RightHipTposeAdjustment", 16 /* CFrame */);
  }
  set RightHipTposeAdjustment(value) {
    this.SetProp("RightHipTposeAdjustment", 16 /* CFrame */, value);
  }
  get RightKnee() {
    return this.GetProp("RightKnee", 19 /* Referent */);
  }
  set RightKnee(value) {
    this.SetProp("RightKnee", 19 /* Referent */, value);
  }
  get RightKneeRangeMax() {
    return this.GetProp("RightKneeRangeMax", 14 /* Vector3 */);
  }
  set RightKneeRangeMax(value) {
    this.SetProp("RightKneeRangeMax", 14 /* Vector3 */, value);
  }
  get RightKneeRangeMin() {
    return this.GetProp("RightKneeRangeMin", 14 /* Vector3 */);
  }
  set RightKneeRangeMin(value) {
    this.SetProp("RightKneeRangeMin", 14 /* Vector3 */, value);
  }
  get RightKneeSize() {
    return this.GetProp("RightKneeSize", 4 /* Float32 */);
  }
  set RightKneeSize(value) {
    this.SetProp("RightKneeSize", 4 /* Float32 */, value);
  }
  get RightKneeTposeAdjustment() {
    return this.GetProp("RightKneeTposeAdjustment", 16 /* CFrame */);
  }
  set RightKneeTposeAdjustment(value) {
    this.SetProp("RightKneeTposeAdjustment", 16 /* CFrame */, value);
  }
  get RightShoulder() {
    return this.GetProp("RightShoulder", 19 /* Referent */);
  }
  set RightShoulder(value) {
    this.SetProp("RightShoulder", 19 /* Referent */, value);
  }
  get RightShoulderRangeMax() {
    return this.GetProp("RightShoulderRangeMax", 14 /* Vector3 */);
  }
  set RightShoulderRangeMax(value) {
    this.SetProp("RightShoulderRangeMax", 14 /* Vector3 */, value);
  }
  get RightShoulderRangeMin() {
    return this.GetProp("RightShoulderRangeMin", 14 /* Vector3 */);
  }
  set RightShoulderRangeMin(value) {
    this.SetProp("RightShoulderRangeMin", 14 /* Vector3 */, value);
  }
  get RightShoulderSize() {
    return this.GetProp("RightShoulderSize", 4 /* Float32 */);
  }
  set RightShoulderSize(value) {
    this.SetProp("RightShoulderSize", 4 /* Float32 */, value);
  }
  get RightShoulderTposeAdjustment() {
    return this.GetProp("RightShoulderTposeAdjustment", 16 /* CFrame */);
  }
  set RightShoulderTposeAdjustment(value) {
    this.SetProp("RightShoulderTposeAdjustment", 16 /* CFrame */, value);
  }
  get RightToes() {
    return this.GetProp("RightToes", 19 /* Referent */);
  }
  set RightToes(value) {
    this.SetProp("RightToes", 19 /* Referent */, value);
  }
  get RightToesRangeMax() {
    return this.GetProp("RightToesRangeMax", 14 /* Vector3 */);
  }
  set RightToesRangeMax(value) {
    this.SetProp("RightToesRangeMax", 14 /* Vector3 */, value);
  }
  get RightToesRangeMin() {
    return this.GetProp("RightToesRangeMin", 14 /* Vector3 */);
  }
  set RightToesRangeMin(value) {
    this.SetProp("RightToesRangeMin", 14 /* Vector3 */, value);
  }
  get RightToesSize() {
    return this.GetProp("RightToesSize", 4 /* Float32 */);
  }
  set RightToesSize(value) {
    this.SetProp("RightToesSize", 4 /* Float32 */, value);
  }
  get RightToesTposeAdjustment() {
    return this.GetProp("RightToesTposeAdjustment", 16 /* CFrame */);
  }
  set RightToesTposeAdjustment(value) {
    this.SetProp("RightToesTposeAdjustment", 16 /* CFrame */, value);
  }
  get RightWrist() {
    return this.GetProp("RightWrist", 19 /* Referent */);
  }
  set RightWrist(value) {
    this.SetProp("RightWrist", 19 /* Referent */, value);
  }
  get RightWristRangeMax() {
    return this.GetProp("RightWristRangeMax", 14 /* Vector3 */);
  }
  set RightWristRangeMax(value) {
    this.SetProp("RightWristRangeMax", 14 /* Vector3 */, value);
  }
  get RightWristRangeMin() {
    return this.GetProp("RightWristRangeMin", 14 /* Vector3 */);
  }
  set RightWristRangeMin(value) {
    this.SetProp("RightWristRangeMin", 14 /* Vector3 */, value);
  }
  get RightWristSize() {
    return this.GetProp("RightWristSize", 4 /* Float32 */);
  }
  set RightWristSize(value) {
    this.SetProp("RightWristSize", 4 /* Float32 */, value);
  }
  get RightWristTposeAdjustment() {
    return this.GetProp("RightWristTposeAdjustment", 16 /* CFrame */);
  }
  set RightWristTposeAdjustment(value) {
    this.SetProp("RightWristTposeAdjustment", 16 /* CFrame */, value);
  }
  get Root() {
    return this.GetProp("Root", 19 /* Referent */);
  }
  set Root(value) {
    this.SetProp("Root", 19 /* Referent */, value);
  }
  get RootRangeMax() {
    return this.GetProp("RootRangeMax", 14 /* Vector3 */);
  }
  set RootRangeMax(value) {
    this.SetProp("RootRangeMax", 14 /* Vector3 */, value);
  }
  get RootRangeMin() {
    return this.GetProp("RootRangeMin", 14 /* Vector3 */);
  }
  set RootRangeMin(value) {
    this.SetProp("RootRangeMin", 14 /* Vector3 */, value);
  }
  get RootSize() {
    return this.GetProp("RootSize", 4 /* Float32 */);
  }
  set RootSize(value) {
    this.SetProp("RootSize", 4 /* Float32 */, value);
  }
  get RootTposeAdjustment() {
    return this.GetProp("RootTposeAdjustment", 16 /* CFrame */);
  }
  set RootTposeAdjustment(value) {
    this.SetProp("RootTposeAdjustment", 16 /* CFrame */, value);
  }
  get Waist() {
    return this.GetProp("Waist", 19 /* Referent */);
  }
  set Waist(value) {
    this.SetProp("Waist", 19 /* Referent */, value);
  }
  get WaistRangeMax() {
    return this.GetProp("WaistRangeMax", 14 /* Vector3 */);
  }
  set WaistRangeMax(value) {
    this.SetProp("WaistRangeMax", 14 /* Vector3 */, value);
  }
  get WaistRangeMin() {
    return this.GetProp("WaistRangeMin", 14 /* Vector3 */);
  }
  set WaistRangeMin(value) {
    this.SetProp("WaistRangeMin", 14 /* Vector3 */, value);
  }
  get WaistSize() {
    return this.GetProp("WaistSize", 4 /* Float32 */);
  }
  set WaistSize(value) {
    this.SetProp("WaistSize", 4 /* Float32 */, value);
  }
  get WaistTposeAdjustment() {
    return this.GetProp("WaistTposeAdjustment", 16 /* CFrame */);
  }
  set WaistTposeAdjustment(value) {
    this.SetProp("WaistTposeAdjustment", 16 /* CFrame */, value);
  }
};
...
var InputAction = class extends Instance {
  constructor() {
    super();
...
var InputBinding = class extends Instance {
  constructor() {
    super();
  ...
  get Down() {
    return this.GetProp("Down", 18 /* Enum */);
  }
  set Down(value) {
    this.SetProp("Down", 18 /* Enum */, value);
  }
  get KeyCode() {
    return this.GetProp("KeyCode", 18 /* Enum */);
  }
  set KeyCode(value) {
    this.SetProp("KeyCode", 18 /* Enum */, value);
  }
  get Left() {
    return this.GetProp("Left", 18 /* Enum */);
  }
  set Left(value) {
    this.SetProp("Left", 18 /* Enum */, value);
  }
  get PressedThreshold() {
    return this.GetProp("PressedThreshold", 4 /* Float32 */);
  }
  set PressedThreshold(value) {
    this.SetProp("PressedThreshold", 4 /* Float32 */, value);
  }
  get ReleasedThreshold() {
    return this.GetProp("ReleasedThreshold", 4 /* Float32 */);
  }
  set ReleasedThreshold(value) {
    this.SetProp("ReleasedThreshold", 4 /* Float32 */, value);
  }
  get Right() {
    return this.GetProp("Right", 18 /* Enum */);
  }
  set Right(value) {
    this.SetProp("Right", 18 /* Enum */, value);
  }
  get Scale() {
  ...
  get UIButton() {
    return this.GetProp("UIButton", 19 /* Referent */);
  }
  set UIButton(value) {
    this.SetProp("UIButton", 19 /* Referent */, value);
  }
  get Up() {
    return this.GetProp("Up", 18 /* Enum */);
  }
  set Up(value) {
    this.SetProp("Up", 18 /* Enum */, value);
  }
  get Vector2Scale() {
    return this.GetProp("Vector2Scale", 13 /* Vector2 */);
  }
  set Vector2Scale(value) {
    this.SetProp("Vector2Scale", 13 /* Vector2 */, value);
  }
};
var InputContext = class extends Instance {
  constructor() {
    super();
  ...
  get Sink() {
    return this.GetProp("Sink", 2 /* Bool */);
  }
  set Sink(value) {
    this.SetProp("Sink", 2 /* Bool */, value);
  }
};
...
var Lighting = class extends Instance {
  ...
  get LightingStyle() {
    return this.GetProp("LightingStyle", 18 /* Enum */);
  }
  set LightingStyle(value) {
    this.SetProp("LightingStyle", 18 /* Enum */, value);
  }
  get OutdoorAmbient() {
  ...
  get PrioritizeLightingQuality() {
    return this.GetProp("PrioritizeLightingQuality", 2 /* Bool */);
  }
  set PrioritizeLightingQuality(value) {
    this.SetProp("PrioritizeLightingQuality", 2 /* Bool */, value);
  }
  /**@deprecated Deprecated by Roblox*/
  get ShadowColor() {
...
var LinkingService = class extends Instance {
  constructor() {
    super(true);
...
var LiveSyncService = class extends Instance {
  constructor() {
    super(true);
...
var AuroraScript = class extends LuaSourceContainer {
  constructor() {
    super();
  ...
  get EnableCulling() {
    return this.GetProp("EnableCulling", 2 /* Bool */);
  }
  set EnableCulling(value) {
    this.SetProp("EnableCulling", 2 /* Bool */, value);
  }
  get EnableLOD() {
    return this.GetProp("EnableLOD", 2 /* Bool */);
  }
  set EnableLOD(value) {
    this.SetProp("EnableLOD", 2 /* Bool */, value);
  }
  get LODCriticality() {
    return this.GetProp("LODCriticality", 3 /* Int32 */);
  }
  set LODCriticality(value) {
    this.SetProp("LODCriticality", 3 /* Int32 */, value);
  }
  get Priority() {
    return this.GetProp("Priority", 3 /* Int32 */);
  }
...
var MLModelDeliveryService = class extends Instance {
  constructor() {
    super(true);
...
var MatchmakingService = class extends Instance {
  constructor() {
    super(true);
...
var BasePart = class extends PVInstance {
  ...
  get AudioCanCollide() {
    return this.GetProp("AudioCanCollide", 2 /* Bool */);
  }
  set AudioCanCollide(value) {
    this.SetProp("AudioCanCollide", 2 /* Bool */, value);
  }
  /**@deprecated Deprecated by Roblox*/
  get BackParamA() {
...
var TriangleMeshPart = class extends BasePart {
  ...
  get UnscaledCofm() {
    return this.GetProp("UnscaledCofm", 14 /* Vector3 */);
  }
  set UnscaledCofm(value) {
    this.SetProp("UnscaledCofm", 14 /* Vector3 */, value);
  }
  get UnscaledVolInertiaDiags() {
    return this.GetProp("UnscaledVolInertiaDiags", 14 /* Vector3 */);
  }
  set UnscaledVolInertiaDiags(value) {
    this.SetProp("UnscaledVolInertiaDiags", 14 /* Vector3 */, value);
  }
  get UnscaledVolInertiaOffDiags() {
    return this.GetProp("UnscaledVolInertiaOffDiags", 14 /* Vector3 */);
  }
  set UnscaledVolInertiaOffDiags(value) {
    this.SetProp("UnscaledVolInertiaOffDiags", 14 /* Vector3 */, value);
  }
  get UnscaledVolume() {
    return this.GetProp("UnscaledVolume", 4 /* Float32 */);
  }
  set UnscaledVolume(value) {
    this.SetProp("UnscaledVolume", 4 /* Float32 */, value);
  }
};
var MeshPart = class extends TriangleMeshPart {
  ...
  get MeshContent() {
    return this.GetProp("MeshContent", 1 /* String */);
  }
  set MeshContent(value) {
    this.SetProp("MeshContent", 1 /* String */, value);
  }
  /**@deprecated Deprecated by Roblox*/
  get MeshID() {
    return this.GetProp("MeshID", 1 /* String */);
...
var PartOperation = class extends TriangleMeshPart {
  ...
  get ComponentIndex() {
    return this.GetProp("ComponentIndex", 3 /* Int32 */);
  }
  set ComponentIndex(value) {
    this.SetProp("ComponentIndex", 3 /* Int32 */, value);
  }
  get FormFactor() {
    return this.GetProp("FormFactor", 18 /* Enum */);
  }
  ...
  get OffCentered() {
    return this.GetProp("OffCentered", 2 /* Bool */);
  }
  set OffCentered(value) {
    this.SetProp("OffCentered", 2 /* Bool */, value);
  }
  get PhysicsData() {
    return this.GetProp("PhysicsData", 1 /* String */);
  }
...
var Camera = class extends PVInstance {
  constructor() {
    super();
...
var Workspace = class extends WorldRoot {
  ...
  get FallHeightEnabled() {
    return this.GetProp("FallHeightEnabled", 2 /* Bool */);
  }
  set FallHeightEnabled(value) {
    this.SetProp("FallHeightEnabled", 2 /* Bool */, value);
  }
  ...
  get MoverConstraintRootBehavior() {
    return this.GetProp("MoverConstraintRootBehavior", 18 /* Enum */);
  }
  set MoverConstraintRootBehavior(value) {
    this.SetProp("MoverConstraintRootBehavior", 18 /* Enum */, value);
  }
  get PathfindingUseImprovedSearch() {
    return this.GetProp("PathfindingUseImprovedSearch", 18 /* Enum */);
  }
  set PathfindingUseImprovedSearch(value) {
    this.SetProp("PathfindingUseImprovedSearch", 18 /* Enum */, value);
  }
  get PhysicsImprovedSleep() {
    return this.GetProp("PhysicsImprovedSleep", 18 /* Enum */);
  }
  set PhysicsImprovedSleep(value) {
    this.SetProp("PhysicsImprovedSleep", 18 /* Enum */, value);
  }
  ...
  get RenderingCacheOptimizations() {
    return this.GetProp("RenderingCacheOptimizations", 18 /* Enum */);
  }
  set RenderingCacheOptimizations(value) {
    this.SetProp("RenderingCacheOptimizations", 18 /* Enum */, value);
  }
  ...
  get SandboxedInstanceMode() {
    return this.GetProp("SandboxedInstanceMode", 18 /* Enum */);
  }
  set SandboxedInstanceMode(value) {
    this.SetProp("SandboxedInstanceMode", 18 /* Enum */, value);
  }
  get SignalBehavior2() {
  ...
  get TouchEventsUseCollisionGroups() {
    return this.GetProp("TouchEventsUseCollisionGroups", 18 /* Enum */);
  }
  set TouchEventsUseCollisionGroups(value) {
    this.SetProp("TouchEventsUseCollisionGroups", 18 /* Enum */, value);
  }
...
var PerformanceControlService = class extends Instance {
  constructor() {
    super(true);
...
var PlaceAssetIdsService = class extends Instance {
  constructor() {
    super(true);
...
var Player = class extends Instance {
  ...
  get StepIdOffset() {
    return this.GetProp("StepIdOffset", 3 /* Int32 */);
  }
  set StepIdOffset(value) {
    this.SetProp("StepIdOffset", 3 /* Int32 */, value);
  }
  get Team() {
...
var PlayerDataService = class extends Instance {
  constructor() {
    super(true);
  ...
  get LoadFailureBehavior() {
    return this.GetProp("LoadFailureBehavior", 18 /* Enum */);
  }
  set LoadFailureBehavior(value) {
    this.SetProp("LoadFailureBehavior", 18 /* Enum */, value);
  }
};
var PlayerEmulatorService = class extends Instance {
  ...
  get TextElongationFactor() {
    return this.GetProp("TextElongationFactor", 3 /* Int32 */);
  }
  set TextElongationFactor(value) {
    this.SetProp("TextElongationFactor", 3 /* Int32 */, value);
  }
};
var PlayerHydrationService = class extends Instance {
  constructor() {
    super(true);
...
var Players = class extends Instance {
  ...
  get BanningEnabled() {
    return this.GetProp("BanningEnabled", 2 /* Bool */);
  }
  set BanningEnabled(value) {
    this.SetProp("BanningEnabled", 2 /* Bool */, value);
  }
...
var ColorGradingEffect = class extends PostEffect {
  constructor() {
    super();
  ...
  get TonemapperPreset() {
    return this.GetProp("TonemapperPreset", 18 /* Enum */);
  }
  set TonemapperPreset(value) {
    this.SetProp("TonemapperPreset", 18 /* Enum */, value);
  }
};
...
var RTAnimationTracker = class extends Instance {
  constructor() {
    super();
...
var RomarkRbxAnalyticsService = class extends Instance {
  constructor() {
    super(true);
...
var AtmosphereSensor = class extends SensorBase {
  constructor() {
    super();
...
var FluidForceSensor = class extends SensorBase {
  constructor() {
    super();
...
var SerializationService = class extends Instance {
  constructor() {
    super(true);
...
var Sky = class extends Instance {
  ...
  get SkyboxOrientation() {
    return this.GetProp("SkyboxOrientation", 14 /* Vector3 */);
  }
  set SkyboxOrientation(value) {
    this.SetProp("SkyboxOrientation", 14 /* Vector3 */, value);
  }
  get SkyboxRt() {
...
var Sound = class extends Instance {
  ...
  get RollOffMaxDistance() {
    return this.GetProp("RollOffMaxDistance", 4 /* Float32 */);
  }
  set RollOffMaxDistance(value) {
    this.SetProp("RollOffMaxDistance", 4 /* Float32 */, value);
  }
  get RollOffMinDistance() {
    return this.GetProp("RollOffMinDistance", 4 /* Float32 */);
  }
  set RollOffMinDistance(value) {
    this.SetProp("RollOffMinDistance", 4 /* Float32 */, value);
  }
  get RollOffMode() {
...
var SoundService = class extends Instance {
  ...
  get AudioApiByDefault() {
    return this.GetProp("AudioApiByDefault", 18 /* Enum */);
  }
  set AudioApiByDefault(value) {
    this.SetProp("AudioApiByDefault", 18 /* Enum */, value);
  }
  get CharacterSoundsUseNewApi() {
    return this.GetProp("CharacterSoundsUseNewApi", 18 /* Enum */);
  }
  set CharacterSoundsUseNewApi(value) {
    this.SetProp("CharacterSoundsUseNewApi", 18 /* Enum */, value);
  }
  get DefaultListenerLocation() {
    return this.GetProp("DefaultListenerLocation", 18 /* Enum */);
  }
  set DefaultListenerLocation(value) {
    this.SetProp("DefaultListenerLocation", 18 /* Enum */, value);
  }
  get DistanceFactor() {
  ...
  get IsNewExpForAudioApiByDefault() {
    return this.GetProp("IsNewExpForAudioApiByDefault", 2 /* Bool */);
  }
  set IsNewExpForAudioApiByDefault(value) {
    this.SetProp("IsNewExpForAudioApiByDefault", 2 /* Bool */, value);
  }
...
var StartPageService = class extends Instance {
  constructor() {
    super(true);
...
var StarterPlayer = class extends Instance {
  ...
  get AvatarJointUpgradeSerializedRollout() {
    return this.GetProp("AvatarJointUpgrade_SerializedRollout", 18 /* Enum */);
  }
  set AvatarJointUpgradeSerializedRollout(value) {
    this.SetProp("AvatarJointUpgrade_SerializedRollout", 18 /* Enum */, value);
  }
  get CameraMaxZoomDistance() {
    return this.GetProp("CameraMaxZoomDistance", 4 /* Float32 */);
  }
  ...
  get ClassicDeath() {
    return this.GetProp("ClassicDeath", 2 /* Bool */);
  }
  set ClassicDeath(value) {
    this.SetProp("ClassicDeath", 2 /* Bool */, value);
  }
  get DevCameraOcclusionMode() {
    return this.GetProp("DevCameraOcclusionMode", 18 /* Enum */);
  }
  ...
  get RagdollDeath() {
    return this.GetProp("RagdollDeath", 2 /* Bool */);
  }
  set RagdollDeath(value) {
    this.SetProp("RagdollDeath", 2 /* Bool */, value);
  }
...
var StudioCameraService = class extends Instance {
  constructor() {
    super(true);
  ...
  get LockCameraSpeed() {
    return this.GetProp("LockCameraSpeed", 2 /* Bool */);
  }
  set LockCameraSpeed(value) {
    this.SetProp("LockCameraSpeed", 2 /* Bool */, value);
  }
};
...
var StudioService = class extends Instance {
  ...
  get Secrets() {
    return this.GetProp("Secrets", 1 /* String */);
  }
  set Secrets(value) {
    this.SetProp("Secrets", 1 /* String */, value);
  }
};
var StudioUserService = class extends Instance {
  constructor() {
    super(true);
...
var SurfaceAppearance = class extends Instance {
  ...
  get ColorMapContent() {
    return this.GetProp("ColorMapContent", 1 /* String */);
  }
  set ColorMapContent(value) {
    this.SetProp("ColorMapContent", 1 /* String */, value);
  }
  get MetalnessMap() {
    return this.GetProp("MetalnessMap", 1 /* String */);
  }
  ...
  get MetalnessMapContent() {
    return this.GetProp("MetalnessMapContent", 1 /* String */);
  }
  set MetalnessMapContent(value) {
    this.SetProp("MetalnessMapContent", 1 /* String */, value);
  }
  get NormalMap() {
    return this.GetProp("NormalMap", 1 /* String */);
  }
  ...
  get NormalMapContent() {
    return this.GetProp("NormalMapContent", 1 /* String */);
  }
  set NormalMapContent(value) {
    this.SetProp("NormalMapContent", 1 /* String */, value);
  }
  get RoughnessMap() {
    return this.GetProp("RoughnessMap", 1 /* String */);
  }
  ...
  get RoughnessMapContent() {
    return this.GetProp("RoughnessMapContent", 1 /* String */);
  }
  set RoughnessMapContent(value) {
    this.SetProp("RoughnessMapContent", 1 /* String */, value);
  }
  get TexturePack() {
    return this.GetProp("TexturePack", 1 /* String */);
  }
...
var SystemThemeService = class extends Instance {
  constructor() {
    super(true);
...
var TelemetryService = class extends Instance {
  constructor() {
    super(true);
...
var TestService = class extends Instance {
  ...
  /**@deprecated Deprecated by Roblox*/
  get Is30FpsThrottleEnabled() {
    return this.GetProp("Is30FpsThrottleEnabled", 2 /* Bool */);
  }
  /**@deprecated Deprecated by Roblox*/
  set Is30FpsThrottleEnabled(value) {
    this.SetProp("Is30FpsThrottleEnabled", 2 /* Bool */, value);
  }
  get IsPhysicsEnvironmentalThrottled() {
    return this.GetProp("IsPhysicsEnvironmentalThrottled", 2 /* Bool */);
  }
  set IsPhysicsEnvironmentalThrottled(value) {
    this.SetProp("IsPhysicsEnvironmentalThrottled", 2 /* Bool */, value);
  }
  get IsSleepAllowed() {
  ...
  get ThrottlePhysicsToRealtime() {
    return this.GetProp("ThrottlePhysicsToRealtime", 2 /* Bool */);
  }
  set ThrottlePhysicsToRealtime(value) {
    this.SetProp("ThrottlePhysicsToRealtime", 2 /* Bool */, value);
  }
  get Timeout() {
    return this.GetProp("Timeout", 5 /* Float64 */);
  }
...
var BubbleChatMessageProperties = class extends TextChatMessageProperties {
  constructor() {
    super();
...
var TextChatService = class extends Instance {
  ...
  get HasSeenDeprecationDialog() {
    return this.GetProp("HasSeenDeprecationDialog", 2 /* Bool */);
  }
  set HasSeenDeprecationDialog(value) {
    this.SetProp("HasSeenDeprecationDialog", 2 /* Bool */, value);
  }
};
...
var UIDragDetector = class extends UIComponent {
  constructor() {
    super();
  ...
  get BoundingBehavior() {
    return this.GetProp("BoundingBehavior", 18 /* Enum */);
  }
  set BoundingBehavior(value) {
    this.SetProp("BoundingBehavior", 18 /* Enum */, value);
  }
  get BoundingUI() {
    return this.GetProp("BoundingUI", 19 /* Referent */);
  }
  set BoundingUI(value) {
    this.SetProp("BoundingUI", 19 /* Referent */, value);
  }
  get CursorIcon() {
    return this.GetProp("CursorIcon", 1 /* String */);
  }
  ...
  get DragAxis() {
    return this.GetProp("DragAxis", 13 /* Vector2 */);
  }
  set DragAxis(value) {
    this.SetProp("DragAxis", 13 /* Vector2 */, value);
  }
  get DragRelativity() {
    return this.GetProp("DragRelativity", 18 /* Enum */);
  }
  set DragRelativity(value) {
    this.SetProp("DragRelativity", 18 /* Enum */, value);
  }
  get DragRotation() {
    return this.GetProp("DragRotation", 4 /* Float32 */);
  }
  set DragRotation(value) {
    this.SetProp("DragRotation", 4 /* Float32 */, value);
  }
  get DragSpace() {
    return this.GetProp("DragSpace", 18 /* Enum */);
  }
  set DragSpace(value) {
    this.SetProp("DragSpace", 18 /* Enum */, value);
  }
  get DragStyle() {
    return this.GetProp("DragStyle", 18 /* Enum */);
  }
  ...
  get DragUDim2() {
    return this.GetProp("DragUDim2", 7 /* UDim2 */);
  }
  set DragUDim2(value) {
    this.SetProp("DragUDim2", 7 /* UDim2 */, value);
  }
  get Enabled() {
    return this.GetProp("Enabled", 2 /* Bool */);
  }
  ...
  get MaxDragTranslation() {
    return this.GetProp("MaxDragTranslation", 7 /* UDim2 */);
  }
  set MaxDragTranslation(value) {
    this.SetProp("MaxDragTranslation", 7 /* UDim2 */, value);
  }
  get MinDragAngle() {
    return this.GetProp("MinDragAngle", 4 /* Float32 */);
  }
  ...
  get MinDragTranslation() {
    return this.GetProp("MinDragTranslation", 7 /* UDim2 */);
  }
  set MinDragTranslation(value) {
    this.SetProp("MinDragTranslation", 7 /* UDim2 */, value);
  }
  get ReferenceUIInstance() {
    return this.GetProp("ReferenceUIInstance", 19 /* Referent */);
  }
  set ReferenceUIInstance(value) {
    this.SetProp("ReferenceUIInstance", 19 /* Referent */, value);
  }
  get ResponseStyle() {
    return this.GetProp("ResponseStyle", 18 /* Enum */);
  }
  ...
  get SelectionModeDragSpeed() {
    return this.GetProp("SelectionModeDragSpeed", 7 /* UDim2 */);
  }
  set SelectionModeDragSpeed(value) {
    this.SetProp("SelectionModeDragSpeed", 7 /* UDim2 */, value);
  }
  get SelectionModeRotateSpeed() {
    return this.GetProp("SelectionModeRotateSpeed", 4 /* Float32 */);
  }
  set SelectionModeRotateSpeed(value) {
    this.SetProp("SelectionModeRotateSpeed", 4 /* Float32 */, value);
  }
  get UIDragSpeedAxisMapping() {
    return this.GetProp("UIDragSpeedAxisMapping", 18 /* Enum */);
  }
  set UIDragSpeedAxisMapping(value) {
    this.SetProp("UIDragSpeedAxisMapping", 18 /* Enum */, value);
  }
};
...
var UIDragDetectorService = class extends Instance {
  constructor() {
    super(true);
...
var UniqueIdLookupService = class extends Instance {
  constructor() {
    super(true);
...
var VRService = class extends Instance {
  ...
  get ControllerModels() {
    return this.GetProp("ControllerModels", 18 /* Enum */);
  }
  set ControllerModels(value) {
    this.SetProp("ControllerModels", 18 /* Enum */, value);
  }
  ...
  get LaserPointer() {
    return this.GetProp("LaserPointer", 18 /* Enum */);
  }
  set LaserPointer(value) {
    this.SetProp("LaserPointer", 18 /* Enum */, value);
  }
};
...
var VideoPlayer = class extends Instance {
  constructor() {
    super();
...
var VoiceChatService = class extends Instance {
  ...
  get DefaultDistanceAttenuation() {
    return this.GetProp("DefaultDistanceAttenuation", 18 /* Enum */);
  }
  set DefaultDistanceAttenuation(value) {
    this.SetProp("DefaultDistanceAttenuation", 18 /* Enum */, value);
  }
...
var WebSocketService = class extends Instance {
  constructor() {
    super(true);
...
var WebViewService = class extends Instance {
  constructor() {
    super(true);
...
var AlphaMode = class _AlphaMode extends EnumItem {
  ...
  static TintMask = new _AlphaMode("TintMask", 2);
  static get Items() {
    return [_AlphaMode.Overlay, _AlphaMode.Transparency, _AlphaMode.TintMask];
  }
  static FromValue(value) {
...
var AudioChannelLayout = class _AudioChannelLayout extends EnumItem {
  static Mono = new _AudioChannelLayout("Mono", 0);
  static Stereo = new _AudioChannelLayout("Stereo", 1);
  static Quad = new _AudioChannelLayout("Quad", 2);
  static Surround_5 = new _AudioChannelLayout("Surround_5", 3);
  static Surround_5_1 = new _AudioChannelLayout("Surround_5_1", 4);
  static Surround_7_1 = new _AudioChannelLayout("Surround_7_1", 5);
  static Surround_7_1_4 = new _AudioChannelLayout("Surround_7_1_4", 6);
  static get Items() {
    return [_AudioChannelLayout.Mono, _AudioChannelLayout.Stereo, _AudioChannelLayout.Quad, _AudioChannelLayout.Surround_5, _AudioChannelLayout.Surround_5_1, _AudioChannelLayout.Surround_7_1, _AudioChannelLayout.Surround_7_1_4];
  }
  static FromValue(value) {
    return _AudioChannelLayout.Items.find((item) => item._value === value);
  }
};
var AudioFilterType = class _AudioFilterType extends EnumItem {
  static Peak = new _AudioFilterType("Peak", 0);
  static LowShelf = new _AudioFilterType("LowShelf", 1);
  static HighShelf = new _AudioFilterType("HighShelf", 2);
  static Lowpass12dB = new _AudioFilterType("Lowpass12dB", 3);
  static Lowpass24dB = new _AudioFilterType("Lowpass24dB", 4);
  static Lowpass48dB = new _AudioFilterType("Lowpass48dB", 5);
  static Highpass12dB = new _AudioFilterType("Highpass12dB", 6);
  static Highpass24dB = new _AudioFilterType("Highpass24dB", 7);
  static Highpass48dB = new _AudioFilterType("Highpass48dB", 8);
  static Bandpass = new _AudioFilterType("Bandpass", 9);
  static Notch = new _AudioFilterType("Notch", 10);
  static Lowpass6dB = new _AudioFilterType("Lowpass6dB", 11);
  static get Items() {
    return [_AudioFilterType.Peak, _AudioFilterType.LowShelf, _AudioFilterType.HighShelf, _AudioFilterType.Lowpass12dB, _AudioFilterType.Lowpass24dB, _AudioFilterType.Lowpass48dB, _AudioFilterType.Highpass12dB, _AudioFilterType.Highpass24dB, _AudioFilterType.Highpass48dB, _AudioFilterType.Bandpass, _AudioFilterType.Notch, _AudioFilterType.Lowpass6dB];
  }
  static FromValue(value) {
    return _AudioFilterType.Items.find((item) => item._value === value);
  }
};
var AudioSimulationFidelity = class _AudioSimulationFidelity extends EnumItem {
  static None = new _AudioSimulationFidelity("None", 0);
  static Automatic = new _AudioSimulationFidelity("Automatic", 1);
  static get Items() {
    return [_AudioSimulationFidelity.None, _AudioSimulationFidelity.Automatic];
  }
  static FromValue(value) {
    return _AudioSimulationFidelity.Items.find((item) => item._value === value);
  }
};
...
var AudioWindowSize = class _AudioWindowSize extends EnumItem {
  static Small = new _AudioWindowSize("Small", 0);
  static Medium = new _AudioWindowSize("Medium", 1);
  static Large = new _AudioWindowSize("Large", 2);
  static get Items() {
    return [_AudioWindowSize.Small, _AudioWindowSize.Medium, _AudioWindowSize.Large];
  }
  static FromValue(value) {
    return _AudioWindowSize.Items.find((item) => item._value === value);
  }
};
...
var AvatarSettingsAccessoryLimitMethod = class _AvatarSettingsAccessoryLimitMethod extends EnumItem {
  static Scale = new _AvatarSettingsAccessoryLimitMethod("Scale", 0);
  static Remove = new _AvatarSettingsAccessoryLimitMethod("Remove", 1);
  static get Items() {
    return [_AvatarSettingsAccessoryLimitMethod.Scale, _AvatarSettingsAccessoryLimitMethod.Remove];
  }
  static FromValue(value) {
    return _AvatarSettingsAccessoryLimitMethod.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsAccessoryMode = class _AvatarSettingsAccessoryMode extends EnumItem {
  static PlayerChoice = new _AvatarSettingsAccessoryMode("PlayerChoice", 0);
  static CustomLimit = new _AvatarSettingsAccessoryMode("CustomLimit", 1);
  static get Items() {
    return [_AvatarSettingsAccessoryMode.PlayerChoice, _AvatarSettingsAccessoryMode.CustomLimit];
  }
  static FromValue(value) {
    return _AvatarSettingsAccessoryMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsAnimationClipsMode = class _AvatarSettingsAnimationClipsMode extends EnumItem {
  static PlayerChoice = new _AvatarSettingsAnimationClipsMode("PlayerChoice", 0);
  static CustomClips = new _AvatarSettingsAnimationClipsMode("CustomClips", 1);
  static get Items() {
    return [_AvatarSettingsAnimationClipsMode.PlayerChoice, _AvatarSettingsAnimationClipsMode.CustomClips];
  }
  static FromValue(value) {
    return _AvatarSettingsAnimationClipsMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsAnimationPacksMode = class _AvatarSettingsAnimationPacksMode extends EnumItem {
  static PlayerChoice = new _AvatarSettingsAnimationPacksMode("PlayerChoice", 0);
  static StandardR15 = new _AvatarSettingsAnimationPacksMode("StandardR15", 1);
  static StandardR6 = new _AvatarSettingsAnimationPacksMode("StandardR6", 2);
  static get Items() {
    return [_AvatarSettingsAnimationPacksMode.PlayerChoice, _AvatarSettingsAnimationPacksMode.StandardR15, _AvatarSettingsAnimationPacksMode.StandardR6];
  }
  static FromValue(value) {
    return _AvatarSettingsAnimationPacksMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsAppearanceMode = class _AvatarSettingsAppearanceMode extends EnumItem {
  static PlayerChoice = new _AvatarSettingsAppearanceMode("PlayerChoice", 0);
  static CustomParts = new _AvatarSettingsAppearanceMode("CustomParts", 1);
  static CustomBody = new _AvatarSettingsAppearanceMode("CustomBody", 2);
  static get Items() {
    return [_AvatarSettingsAppearanceMode.PlayerChoice, _AvatarSettingsAppearanceMode.CustomParts, _AvatarSettingsAppearanceMode.CustomBody];
  }
  static FromValue(value) {
    return _AvatarSettingsAppearanceMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsBuildMode = class _AvatarSettingsBuildMode extends EnumItem {
  static PlayerChoice = new _AvatarSettingsBuildMode("PlayerChoice", 0);
  static CustomBuild = new _AvatarSettingsBuildMode("CustomBuild", 1);
  static get Items() {
    return [_AvatarSettingsBuildMode.PlayerChoice, _AvatarSettingsBuildMode.CustomBuild];
  }
  static FromValue(value) {
    return _AvatarSettingsBuildMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsClothingMode = class _AvatarSettingsClothingMode extends EnumItem {
  static PlayerChoice = new _AvatarSettingsClothingMode("PlayerChoice", 0);
  static CustomLimit = new _AvatarSettingsClothingMode("CustomLimit", 1);
  static get Items() {
    return [_AvatarSettingsClothingMode.PlayerChoice, _AvatarSettingsClothingMode.CustomLimit];
  }
  static FromValue(value) {
    return _AvatarSettingsClothingMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsCollisionMode = class _AvatarSettingsCollisionMode extends EnumItem {
  static Default = new _AvatarSettingsCollisionMode("Default", 0);
  static SingleCollider = new _AvatarSettingsCollisionMode("SingleCollider", 1);
  static Legacy = new _AvatarSettingsCollisionMode("Legacy", 2);
  static get Items() {
    return [_AvatarSettingsCollisionMode.Default, _AvatarSettingsCollisionMode.SingleCollider, _AvatarSettingsCollisionMode.Legacy];
  }
  static FromValue(value) {
    return _AvatarSettingsCollisionMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsCustomAccessoryMode = class _AvatarSettingsCustomAccessoryMode extends EnumItem {
  static PlayerChoice = new _AvatarSettingsCustomAccessoryMode("PlayerChoice", 0);
  static CustomAccessories = new _AvatarSettingsCustomAccessoryMode("CustomAccessories", 1);
  static get Items() {
    return [_AvatarSettingsCustomAccessoryMode.PlayerChoice, _AvatarSettingsCustomAccessoryMode.CustomAccessories];
  }
  static FromValue(value) {
    return _AvatarSettingsCustomAccessoryMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsCustomBodyType = class _AvatarSettingsCustomBodyType extends EnumItem {
  static AvatarReference = new _AvatarSettingsCustomBodyType("AvatarReference", 0);
  static BundleId = new _AvatarSettingsCustomBodyType("BundleId", 1);
  static get Items() {
    return [_AvatarSettingsCustomBodyType.AvatarReference, _AvatarSettingsCustomBodyType.BundleId];
  }
  static FromValue(value) {
    return _AvatarSettingsCustomBodyType.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsCustomClothingMode = class _AvatarSettingsCustomClothingMode extends EnumItem {
  static PlayerChoice = new _AvatarSettingsCustomClothingMode("PlayerChoice", 0);
  static CustomClothing = new _AvatarSettingsCustomClothingMode("CustomClothing", 1);
  static get Items() {
    return [_AvatarSettingsCustomClothingMode.PlayerChoice, _AvatarSettingsCustomClothingMode.CustomClothing];
  }
  static FromValue(value) {
    return _AvatarSettingsCustomClothingMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsHitAndTouchDetectionMode = class _AvatarSettingsHitAndTouchDetectionMode extends EnumItem {
  static UseParts = new _AvatarSettingsHitAndTouchDetectionMode("UseParts", 0);
  static UseCollider = new _AvatarSettingsHitAndTouchDetectionMode("UseCollider", 1);
  static get Items() {
    return [_AvatarSettingsHitAndTouchDetectionMode.UseParts, _AvatarSettingsHitAndTouchDetectionMode.UseCollider];
  }
  static FromValue(value) {
    return _AvatarSettingsHitAndTouchDetectionMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsLegacyCollisionMode = class _AvatarSettingsLegacyCollisionMode extends EnumItem {
  static R6Colliders = new _AvatarSettingsLegacyCollisionMode("R6Colliders", 0);
  static InnerBoxColliders = new _AvatarSettingsLegacyCollisionMode("InnerBoxColliders", 1);
  static get Items() {
    return [_AvatarSettingsLegacyCollisionMode.R6Colliders, _AvatarSettingsLegacyCollisionMode.InnerBoxColliders];
  }
  static FromValue(value) {
    return _AvatarSettingsLegacyCollisionMode.Items.find((item) => item._value === value);
  }
};
var AvatarSettingsScaleMode = class _AvatarSettingsScaleMode extends EnumItem {
  static PlayerChoice = new _AvatarSettingsScaleMode("PlayerChoice", 0);
  static CustomScale = new _AvatarSettingsScaleMode("CustomScale", 1);
  static get Items() {
    return [_AvatarSettingsScaleMode.PlayerChoice, _AvatarSettingsScaleMode.CustomScale];
  }
  static FromValue(value) {
    return _AvatarSettingsScaleMode.Items.find((item) => item._value === value);
  }
};
...
var HapticEffectType = class _HapticEffectType extends EnumItem {
  static Custom = new _HapticEffectType("Custom", 0);
  static UIHover = new _HapticEffectType("UIHover", 1);
  static UIClick = new _HapticEffectType("UIClick", 2);
  static UINotification = new _HapticEffectType("UINotification", 3);
  static GameplayExplosion = new _HapticEffectType("GameplayExplosion", 4);
  static GameplayCollision = new _HapticEffectType("GameplayCollision", 5);
  static get Items() {
    return [_HapticEffectType.Custom, _HapticEffectType.UIHover, _HapticEffectType.UIClick, _HapticEffectType.UINotification, _HapticEffectType.GameplayExplosion, _HapticEffectType.GameplayCollision];
  }
  static FromValue(value) {
    return _HapticEffectType.Items.find((item) => item._value === value);
  }
};
...
var InputActionType = class _InputActionType extends EnumItem {
  static Bool = new _InputActionType("Bool", 0);
  static Direction1D = new _InputActionType("Direction1D", 1);
  static Direction2D = new _InputActionType("Direction2D", 2);
  static get Items() {
    return [_InputActionType.Bool, _InputActionType.Direction1D, _InputActionType.Direction2D];
  }
  static FromValue(value) {
    return _InputActionType.Items.find((item) => item._value === value);
  }
};
...
var LightingStyle = class _LightingStyle extends EnumItem {
  static Realistic = new _LightingStyle("Realistic", 0);
  static Soft = new _LightingStyle("Soft", 1);
  static get Items() {
    return [_LightingStyle.Realistic, _LightingStyle.Soft];
  }
  static FromValue(value) {
    return _LightingStyle.Items.find((item) => item._value === value);
  }
};
...
var ListenerLocation = class _ListenerLocation extends EnumItem {
  static Default = new _ListenerLocation("Default", 0);
  static None = new _ListenerLocation("None", 1);
  static Character = new _ListenerLocation("Character", 2);
  static Camera = new _ListenerLocation("Camera", 3);
  static get Items() {
    return [_ListenerLocation.Default, _ListenerLocation.None, _ListenerLocation.Character, _ListenerLocation.Camera];
  }
  static FromValue(value) {
    return _ListenerLocation.Items.find((item) => item._value === value);
  }
};
...
var MoverConstraintRootBehaviorMode = class _MoverConstraintRootBehaviorMode extends EnumItem {
  static Default = new _MoverConstraintRootBehaviorMode("Default", 0);
  static Disabled = new _MoverConstraintRootBehaviorMode("Disabled", 1);
  static Enabled = new _MoverConstraintRootBehaviorMode("Enabled", 2);
  static get Items() {
    return [_MoverConstraintRootBehaviorMode.Default, _MoverConstraintRootBehaviorMode.Disabled, _MoverConstraintRootBehaviorMode.Enabled];
  }
  static FromValue(value) {
    return _MoverConstraintRootBehaviorMode.Items.find((item) => item._value === value);
  }
};
...
var PathfindingUseImprovedSearch = class _PathfindingUseImprovedSearch extends EnumItem {
  static Default = new _PathfindingUseImprovedSearch("Default", 0);
  static Disabled = new _PathfindingUseImprovedSearch("Disabled", 1);
  static Enabled = new _PathfindingUseImprovedSearch("Enabled", 2);
  static get Items() {
    return [_PathfindingUseImprovedSearch.Default, _PathfindingUseImprovedSearch.Disabled, _PathfindingUseImprovedSearch.Enabled];
  }
  static FromValue(value) {
    return _PathfindingUseImprovedSearch.Items.find((item) => item._value === value);
  }
};
...
var PlayerDataLoadFailureBehavior = class _PlayerDataLoadFailureBehavior extends EnumItem {
  static Failure = new _PlayerDataLoadFailureBehavior("Failure", 0);
  static FallbackToDefault = new _PlayerDataLoadFailureBehavior("FallbackToDefault", 1);
  static Kick = new _PlayerDataLoadFailureBehavior("Kick", 2);
  static get Items() {
    return [_PlayerDataLoadFailureBehavior.Failure, _PlayerDataLoadFailureBehavior.FallbackToDefault, _PlayerDataLoadFailureBehavior.Kick];
  }
  static FromValue(value) {
    return _PlayerDataLoadFailureBehavior.Items.find((item) => item._value === value);
  }
};
...
var PoseEasingStyle = class _PoseEasingStyle extends EnumItem {
  ...
  static CubicV2 = new _PoseEasingStyle("CubicV2", 5);
  static get Items() {
    return [_PoseEasingStyle.Linear, _PoseEasingStyle.Constant, _PoseEasingStyle.Elastic, _PoseEasingStyle.Cubic, _PoseEasingStyle.Bounce, _PoseEasingStyle.CubicV2];
  }
  static FromValue(value) {
...
var RenderingCacheOptimizationMode = class _RenderingCacheOptimizationMode extends EnumItem {
  static Default = new _RenderingCacheOptimizationMode("Default", 0);
  static Disabled = new _RenderingCacheOptimizationMode("Disabled", 1);
  static Enabled = new _RenderingCacheOptimizationMode("Enabled", 2);
  static get Items() {
    return [_RenderingCacheOptimizationMode.Default, _RenderingCacheOptimizationMode.Disabled, _RenderingCacheOptimizationMode.Enabled];
  }
  static FromValue(value) {
    return _RenderingCacheOptimizationMode.Items.find((item) => item._value === value);
  }
};
...
var RolloutState = class _RolloutState extends EnumItem {
  static Default = new _RolloutState("Default", 0);
  static Disabled = new _RolloutState("Disabled", 1);
  static Enabled = new _RolloutState("Enabled", 2);
  static get Items() {
    return [_RolloutState.Default, _RolloutState.Disabled, _RolloutState.Enabled];
  }
  static FromValue(value) {
    return _RolloutState.Items.find((item) => item._value === value);
  }
};
...
var SandboxedInstanceMode = class _SandboxedInstanceMode extends EnumItem {
  static Default = new _SandboxedInstanceMode("Default", 0);
  static Experimental = new _SandboxedInstanceMode("Experimental", 1);
  static get Items() {
    return [_SandboxedInstanceMode.Default, _SandboxedInstanceMode.Experimental];
  }
  static FromValue(value) {
    return _SandboxedInstanceMode.Items.find((item) => item._value === value);
  }
};
...
var Technology = class _Technology extends EnumItem {
  ...
  static Unified = new _Technology("Unified", 5);
  static get Items() {
    return [_Technology.Voxel, _Technology.Compatibility, _Technology.ShadowMap, _Technology.Future, _Technology.Legacy, _Technology.Unified];
  }
  static FromValue(value) {
...
var TonemapperPreset = class _TonemapperPreset extends EnumItem {
  static Default = new _TonemapperPreset("Default", 0);
  static Retro = new _TonemapperPreset("Retro", 1);
  static get Items() {
    return [_TonemapperPreset.Default, _TonemapperPreset.Retro];
  }
  static FromValue(value) {
    return _TonemapperPreset.Items.find((item) => item._value === value);
  }
};
...
var UIDragDetectorBoundingBehavior = class _UIDragDetectorBoundingBehavior extends EnumItem {
  static Automatic = new _UIDragDetectorBoundingBehavior("Automatic", 0);
  static EntireObject = new _UIDragDetectorBoundingBehavior("EntireObject", 1);
  static HitPoint = new _UIDragDetectorBoundingBehavior("HitPoint", 2);
  static get Items() {
    return [_UIDragDetectorBoundingBehavior.Automatic, _UIDragDetectorBoundingBehavior.EntireObject, _UIDragDetectorBoundingBehavior.HitPoint];
  }
  static FromValue(value) {
    return _UIDragDetectorBoundingBehavior.Items.find((item) => item._value === value);
  }
};
var UIDragDetectorDragRelativity = class _UIDragDetectorDragRelativity extends EnumItem {
  static Absolute = new _UIDragDetectorDragRelativity("Absolute", 0);
  static Relative = new _UIDragDetectorDragRelativity("Relative", 1);
  static get Items() {
    return [_UIDragDetectorDragRelativity.Absolute, _UIDragDetectorDragRelativity.Relative];
  }
  static FromValue(value) {
    return _UIDragDetectorDragRelativity.Items.find((item) => item._value === value);
  }
};
var UIDragDetectorDragSpace = class _UIDragDetectorDragSpace extends EnumItem {
  static Parent = new _UIDragDetectorDragSpace("Parent", 0);
  static LayerCollector = new _UIDragDetectorDragSpace("LayerCollector", 1);
  static Reference = new _UIDragDetectorDragSpace("Reference", 2);
  static get Items() {
    return [_UIDragDetectorDragSpace.Parent, _UIDragDetectorDragSpace.LayerCollector, _UIDragDetectorDragSpace.Reference];
  }
  static FromValue(value) {
    return _UIDragDetectorDragSpace.Items.find((item) => item._value === value);
  }
};
var UIDragDetectorDragStyle = class _UIDragDetectorDragStyle extends EnumItem {
  static TranslatePlane = new _UIDragDetectorDragStyle("TranslatePlane", 0);
  static TranslateLine = new _UIDragDetectorDragStyle("TranslateLine", 1);
  static Rotate = new _UIDragDetectorDragStyle("Rotate", 2);
  static Scriptable = new _UIDragDetectorDragStyle("Scriptable", 3);
  static get Items() {
    return [_UIDragDetectorDragStyle.TranslatePlane, _UIDragDetectorDragStyle.TranslateLine, _UIDragDetectorDragStyle.Rotate, _UIDragDetectorDragStyle.Scriptable];
  }
  static FromValue(value) {
    return _UIDragDetectorDragStyle.Items.find((item) => item._value === value);
  }
};
var UIDragDetectorResponseStyle = class _UIDragDetectorResponseStyle extends EnumItem {
  static Offset = new _UIDragDetectorResponseStyle("Offset", 0);
  static Scale = new _UIDragDetectorResponseStyle("Scale", 1);
  static CustomOffset = new _UIDragDetectorResponseStyle("CustomOffset", 2);
  static CustomScale = new _UIDragDetectorResponseStyle("CustomScale", 3);
  static get Items() {
    return [_UIDragDetectorResponseStyle.Offset, _UIDragDetectorResponseStyle.Scale, _UIDragDetectorResponseStyle.CustomOffset, _UIDragDetectorResponseStyle.CustomScale];
  }
  static FromValue(value) {
    return _UIDragDetectorResponseStyle.Items.find((item) => item._value === value);
  }
};
var UIDragSpeedAxisMapping = class _UIDragSpeedAxisMapping extends EnumItem {
  static XY = new _UIDragSpeedAxisMapping("XY", 0);
  static XX = new _UIDragSpeedAxisMapping("XX", 1);
  static YY = new _UIDragSpeedAxisMapping("YY", 2);
  static get Items() {
    return [_UIDragSpeedAxisMapping.XY, _UIDragSpeedAxisMapping.XX, _UIDragSpeedAxisMapping.YY];
  }
  static FromValue(value) {
    return _UIDragSpeedAxisMapping.Items.find((item) => item._value === value);
  }
};
...
var VRControllerModelMode = class _VRControllerModelMode extends EnumItem {
  static Disabled = new _VRControllerModelMode("Disabled", 0);
  static Transparent = new _VRControllerModelMode("Transparent", 1);
  static get Items() {
    return [_VRControllerModelMode.Disabled, _VRControllerModelMode.Transparent];
  }
  static FromValue(value) {
    return _VRControllerModelMode.Items.find((item) => item._value === value);
  }
};
var VRLaserPointerMode = class _VRLaserPointerMode extends EnumItem {
  static Disabled = new _VRLaserPointerMode("Disabled", 0);
  static Pointer = new _VRLaserPointerMode("Pointer", 1);
  static DualPointer = new _VRLaserPointerMode("DualPointer", 2);
  static get Items() {
    return [_VRLaserPointerMode.Disabled, _VRLaserPointerMode.Pointer, _VRLaserPointerMode.DualPointer];
  }
  static FromValue(value) {
    return _VRLaserPointerMode.Items.find((item) => item._value === value);
  }
};
...
var VoiceChatDistanceAttenuationType = class _VoiceChatDistanceAttenuationType extends EnumItem {
  static Inverse = new _VoiceChatDistanceAttenuationType("Inverse", 0);
  static Legacy = new _VoiceChatDistanceAttenuationType("Legacy", 1);
  static get Items() {
    return [_VoiceChatDistanceAttenuationType.Inverse, _VoiceChatDistanceAttenuationType.Legacy];
  }
  static FromValue(value) {
    return _VoiceChatDistanceAttenuationType.Items.find((item) => item._value === value);
  }
};
...
var RobloxFileDOMWriter = class extends RobloxFileDOM {
    ...
    for (const instance of instances) {
      ...
      if (!classNameToId.has(instance.ClassName)) {
        ...
        this.classIdToInfo.set(lastClassId, {
          ...
          instances: [instance],
          referentIdToIndex: /* @__PURE__ */ new Map([[lastReferent, 0]])
        });
  ...
  compressData(type, data) {
    ...
    const bytes = Buffer.alloc(lz42.encodeBound(data.length));
    const size = lz42.encodeBlock(Buffer.from(data), bytes);
    return {
  ...
  getPropFromInstance(instance, propName) {
...
var RobloxFile = class extends ChildContainer {
  /**
